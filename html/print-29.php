...
<<<<<<< TREE
	CMS_view::redirect('http://test-folder/trunk/web/demo/print-29-automne-v4.php', true, 301);
=======
	CMS_view::redirect('http://127.0.0.1/web/demo/print-29-automne-v4.php', true, 301);
>>>>>>> MERGE-SOURCE
}
...
<<<<<<< TREE
				Page  "Automne" (http://test-folder/trunk/web/demo/29-automne-v4.php)
=======
				Page  "Automne" (http://127.0.0.1/web/demo/29-automne-v4.php)
>>>>>>> MERGE-SOURCE
				<br />
