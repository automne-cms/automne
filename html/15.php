<?php //Generated on Tue, 25 Nov 2008 16:54:14 +0100 by Automne (TM) 4.0.0a
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	header('HTTP/1.x 301 Moved Permanently', true, 301);
	header('Location: http://automne4/web/fr/15-module-actualites-mediatheque.php');
	exit;
}
...
<head>
	<title>Automne 4 : Modules Actualités, Médiathèque, Formulaires, Alias</title>
...
<li class="CMS_lvl2 CMS_open "><a class="CMS_lvl2" href="http://automne4/web/fr/4-fonctionnalites.php">Fonctionnalités</a><ul class="CMS_lvl3"><li class="CMS_lvl3 CMS_nosub "><a class="CMS_lvl3" href="http://automne4/web/fr/11-gestion-de-contenu.php">Gestion de contenu</a></li>
...
<li class="CMS_lvl3 CMS_nosub CMS_current"><a class="CMS_lvl3" href="http://automne4/web/fr/15-module-actualites-mediatheque.php">Les modules</a></li>
...
<li class="CMS_lvl2 CMS_nosub "><a class="CMS_lvl2" href="http://automne4/web/fr/6-mediatheque.php">Médiathèque</a></li>
 ...
 &gt; 
<a href="http://automne4/web/fr/4-fonctionnalites.php">Fonctionnalités</a>
 &gt; 

     </div>
     <div id="title">
      <h1>Modules Actualités, Médiathèque, Formulaires, Alias</h1>
     </div>
