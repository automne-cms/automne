<?php //Generated on Fri, 06 Mar 2009 12:04:44 +0100 by Automne (TM) 4.0.0b1
...
<h2>Principe de gestion des droits</h2>
	...
	<div class="imgRight">
		<?php //Generated by : $Id: print-35.php,v 1.1 2009/03/06 11:01:50 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH mediaresult TAG START 16_775bea
$objectDefinition_mediaresult = '2';
if (!isset($objectDefinitions[$objectDefinition_mediaresult])) {
	$objectDefinitions[$objectDefinition_mediaresult] = new CMS_poly_object_definition($objectDefinition_mediaresult);
}
//public search ?
$public_16_775bea = isset($public_search) ? $public_search : false;
//get search params
$search_mediaresult = new CMS_object_search($objectDefinitions[$objectDefinition_mediaresult], $public_16_775bea);
$launchSearch_mediaresult = true;
//add search conditions if any
if ($blockAttributes['search']['mediaresult']['item']) {
	$values_17_d1c98b = array (
		'search' => 'mediaresult',
		'type' => 'item',
		'value' => 'block',
		'mandatory' => 'true',
	);
	$values_17_d1c98b['value'] = $blockAttributes['search']['mediaresult']['item'];
	$launchSearch_mediaresult = (CMS_polymod_definition_parsing::addSearchCondition($search_mediaresult, $values_17_d1c98b)) ? $launchSearch_mediaresult : false;
} elseif (true == true) {
	//search parameter is mandatory and no value found
	$launchSearch_mediaresult = false;
}
//RESULT mediaresult TAG START 18_0924d1
...
if ($results_mediaresult) {
	$object_18_0924d1 = $object[$objectDefinition_mediaresult]; //save previous object search if any
	$replace_18_0924d1 = $replace; //save previous replace vars if any
	$count_18_0924d1 = 0;
	$content_18_0924d1 = $content; //save previous content var if any
	$maxPages_18_0924d1 = $search_mediaresult->getMaxPages();
	$maxResults_18_0924d1 = $search_mediaresult->getNumRows();
	foreach ($results_mediaresult as $object[$objectDefinition_mediaresult]) {
		$content = "";
		$replace["atm-search"] = array (
			"{resultid}" 	=> (isset($resultID_mediaresult)) ? $resultID_mediaresult : $object[$objectDefinition_mediaresult]->getID(),
			"{firstresult}" => (!$count_18_0924d1) ? 1 : 0,
			"{lastresult}" 	=> ($count_18_0924d1 == sizeof($results_mediaresult)-1) ? 1 : 0,
			"{resultcount}" => ($count_18_0924d1+1),
			"{maxpages}"    => $maxPages_18_0924d1,
			"{currentpage}" => ($search_mediaresult->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_18_0924d1,
		);
		//IF TAG START 19_247da1
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 20_a7331e
				$content .=" ".$object[2]->getValue('label','')."</a>
				";
				//IF TAG START 21_00faad
				...
				}//IF TAG END 21_00faad
			}
		}//IF TAG END 19_247da1
		//IF TAG START 22_cdae40
		$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('fileExtension',''))." == 'flv'", $replace);
		if ($ifcondition) {
			$func = create_function("","return (".$ifcondition.");");
			if ($func()) {
				//IF TAG START 23_686e3b
				$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
				...
				}//IF TAG END 23_686e3b
				//IF TAG START 24_0e9f65
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 22_cdae40
		//IF TAG START 25_408b6b
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 26_4a7a72
			}
		}//IF TAG END 25_408b6b
		//IF TAG START 27_a151df
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 28_5899a0
				//IF TAG START 29_a91866
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 27_a151df
		$count_18_0924d1++;
		//do all result vars replacement
		$content_18_0924d1.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_18_0924d1; //retrieve previous content var if any
	$replace = $replace_18_0924d1; //retrieve previous replace vars if any
	$object[$objectDefinition_mediaresult] = $object_18_0924d1; //retrieve previous object search if any
}
//RESULT mediaresult TAG END 18_0924d1
//destroy search and results mediaresult objects
unset($search_mediaresult);
unset($results_mediaresult);
//SEARCH mediaresult TAG END 16_775bea
echo CMS_polymod_definition_parsing::replaceVars($content, $replace);
  ?>
	</div>
	
		<div class="text"><div class="text atm-block block-a307044b7b4f9ba4479764713215ce87 row-6df011fc985a777ebe9b951c174a4f00" id="el-d7a86f944a358efb3554e7ba180d890c"><p>Il existe<strong> trois types de droits fondamentaux</strong> :</p> <ul>     <li style="text-align: left;">Droit d'&eacute;criture &rArr; &eacute;quivaut au <strong>droit d'administration.</strong></li>     <li style="text-align: left;">Droit de lecture &rArr; &eacute;quivaut au <strong>droit de visibilit&eacute;.</strong></li>     <li style="text-align: left;">Aucun droit &rArr; l'utilisateur ne peut voir le contenu.</li> </ul></div> <p>&nbsp;</p></div>
