...
CMS_view::redirect('http://automne4.trunk/web/demo/2-accueil.php', true, 302);
 ?><?php //Generated on Tue, 09 Mar 2010 11:58:45 +0100 by Automne (TM) 4.0.1
require_once($_SERVER["DOCUMENT_ROOT"]."/cms_rc_frontend.php");
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	CMS_view::redirect('http://automne4.trunk/web/1-demo-automne.php', true, 301);
}
