<?php //Generated on Tue, 09 Mar 2010 12:18:07 +0100 by Automne (TM) 4.0.1
...
if(!APPLICATION_ENFORCES_ACCESS_CONTROL || (isset($cms_user) && is_a($cms_user, 'CMS_profile_user') && $cms_user->hasModuleClearance('pnews', CLEARANCE_MODULE_VIEW))){
	...
	<option value=\"\"> </option>
	";
	//FUNCTION TAG START 2_fde56e
	$parameters_2_fde56e = array ('selected' => CMS_polymod_definition_parsing::replaceVars(CMS_poly_definition_functions::getVarContent("request", "cat", "int", @$cat), $replace),);
	$object_2_fde56e = &$object[1]->objectValues(5);
	if (method_exists($object_2_fde56e, "selectOptions")) {
		$content .= CMS_polymod_definition_parsing::replaceVars($object_2_fde56e->selectOptions($parameters_2_fde56e, NULL), $replace);
	} else {
		CMS_grandFather::raiseError("Malformed atm-function tag : can't found method selectOptions on object : ".get_class($object_2_fde56e));
	}
	//FUNCTION TAG END 2_fde56e
	$content .="
	</select>
	</div>
