...
<li class="CMS_lvl2 CMS_nosub CMS_current"><a class="CMS_lvl2" href="http://automne4/web/fr/5-actualite.php">Actualités</a></li>
<li class="CMS_lvl2 CMS_nosub "><a class="CMS_lvl2" href="http://automne4/web/fr/6-mediatheque.php">Médiathèque</a></li>
 ...
 &gt; 
	...
	<?php //Generated by : $Id: 5.php,v 1.1.1.1 2008/11/26 17:12:35 sebastien Exp $
$content = "";
$replace = "";
if (!isset($objectDefinitions) || !is_array($objectDefinitions)) $objectDefinitions = array();
$blockAttributes = array (
...
<option value=\"\"> </option>
";
//FUNCTION TAG START 2_5ffd9f
$parameters_2_5ffd9f = array ('selected' => CMS_polymod_definition_parsing::replaceVars(CMS_poly_definition_functions::getVarContent("request", "cat", "int", @$cat), $replace),);
$object_2_5ffd9f = &$object[1]->objectValues(5);
if (method_exists($object_2_5ffd9f, "selectOptions")) {
	$content .= CMS_polymod_definition_parsing::replaceVars($object_2_5ffd9f->selectOptions($parameters_2_5ffd9f, NULL), $replace);
} else {
	CMS_grandFather::raiseError("Malformed atm-function tag : can't found method selectOptions on object : ".get_class($object_2_5ffd9f));
}
//FUNCTION TAG END 2_5ffd9f
$content .="
</select>
</div>
