...
<body>
	...
	<?php //Generated by : $Id: 5.php,v 1.13 2010/02/01 16:08:05 sebastien Exp $
if(!APPLICATION_ENFORCES_ACCESS_CONTROL || (isset($cms_user) && is_a($cms_user, 'CMS_profile_user') && $cms_user->hasModuleClearance('pnews', CLEARANCE_MODULE_VIEW))){
	...
	<option value=\"\"> </option>
	";
	//FUNCTION TAG START 2_c0a5c7
	$parameters_2_c0a5c7 = array ('selected' => CMS_polymod_definition_parsing::replaceVars(CMS_poly_definition_functions::getVarContent("request", "cat", "int", @$cat), $replace),);
	$object_2_c0a5c7 = &$object[1]->objectValues(5);
	if (method_exists($object_2_c0a5c7, "selectOptions")) {
		$content .= CMS_polymod_definition_parsing::replaceVars($object_2_c0a5c7->selectOptions($parameters_2_c0a5c7, NULL), $replace);
	} else {
		CMS_grandFather::raiseError("Malformed atm-function tag : can't found method selectOptions on object : ".get_class($object_2_c0a5c7));
	}
	//FUNCTION TAG END 2_c0a5c7
	$content .="
	</select>
	</div>
