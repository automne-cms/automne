<?php //Generated on Tue, 09 Mar 2010 15:58:44 +0100 by Automne (TM) 4.0.1
require_once($_SERVER["DOCUMENT_ROOT"]."/cms_rc_frontend.php");
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	CMS_view::redirect('http://automne4.401/web/demo/print-24-documentation.php', true, 301);
}
...
<div align="center">
	<small>
				...
				Page  "Fonctionnalités" (http://automne4.401/web/demo/24-documentation.php)
				<br />
