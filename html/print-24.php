...
=======
<?php //Generated on Mon, 24 May 2010 16:59:55 +0200 by Automne (TM) 4.0.2
>>>>>>> MERGE-SOURCE
require_once($_SERVER["DOCUMENT_ROOT"]."/cms_rc_frontend.php");
>>>>>>> MERGE-SOURCE
if (!isset($cms_page_included) && !$_POST && !$_GET) {
<<<<<<< TREE
	CMS_view::redirect('http://test-folder/trunk/web/demo/print-24-documentation.php', true, 301);
=======
...
<<<<<<< TREE
				Page  "Fonctionnalités" (http://test-folder/trunk/web/demo/24-documentation.php)
=======
