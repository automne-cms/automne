<?php //Generated on Wed, 28 Oct 2009 17:10:32 +0100 by Automne (TM) 4.0.0rc3
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	header('HTTP/1.x 301 Moved Permanently', true, 301);
	header('Location: http://127.0.0.1/web/demo/29-automne-v4.php');
	exit;
}
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
	<head>
		...
		<![endif]-->
		<?php echo CMS_view::getJavascript(array('/js/demo/sifr.js','/js/demo/common.js','/js/CMS_functions.js'));  ?>
