<?php //Generated on Fri, 06 Mar 2009 12:04:47 +0100 by Automne (TM) 4.0.0b1
...
<div class="text"><h2>Principe de validation / publication</h2> <p>Un <strong>syst&egrave;me de validation</strong> (workflow) permet de <strong>conserver plusieurs versions du contenu </strong>(public, en cours d&rsquo;&eacute;dition, en attente de validation, etc.).</p> <p>Lorsqu'une modification est effectu&eacute; sur le contenu du site : pages, actualit&eacute;s, m&eacute;dias, modules ... la modification est enregistr&eacute;e mais elle n'est pas directement publi&eacute;e en ligne.&nbsp;</p></div>


	<div class="imgRight">
		<?php //Generated by : $Id: 37.php,v 1.1 2009/03/06 11:01:49 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH mediaresult TAG START 2_4bee35
$objectDefinition_mediaresult = '2';
if (!isset($objectDefinitions[$objectDefinition_mediaresult])) {
	$objectDefinitions[$objectDefinition_mediaresult] = new CMS_poly_object_definition($objectDefinition_mediaresult);
}
//public search ?
$public_2_4bee35 = isset($public_search) ? $public_search : false;
//get search params
$search_mediaresult = new CMS_object_search($objectDefinitions[$objectDefinition_mediaresult], $public_2_4bee35);
$launchSearch_mediaresult = true;
//add search conditions if any
if ($blockAttributes['search']['mediaresult']['item']) {
	$values_3_91d45e = array (
		'search' => 'mediaresult',
		'type' => 'item',
		'value' => 'block',
		'mandatory' => 'true',
	);
	$values_3_91d45e['value'] = $blockAttributes['search']['mediaresult']['item'];
	$launchSearch_mediaresult = (CMS_polymod_definition_parsing::addSearchCondition($search_mediaresult, $values_3_91d45e)) ? $launchSearch_mediaresult : false;
} elseif (true == true) {
	//search parameter is mandatory and no value found
	$launchSearch_mediaresult = false;
}
//RESULT mediaresult TAG START 4_6a9d82
...
if ($results_mediaresult) {
	$object_4_6a9d82 = $object[$objectDefinition_mediaresult]; //save previous object search if any
	$replace_4_6a9d82 = $replace; //save previous replace vars if any
	$count_4_6a9d82 = 0;
	$content_4_6a9d82 = $content; //save previous content var if any
	$maxPages_4_6a9d82 = $search_mediaresult->getMaxPages();
	$maxResults_4_6a9d82 = $search_mediaresult->getNumRows();
	foreach ($results_mediaresult as $object[$objectDefinition_mediaresult]) {
		$content = "";
		$replace["atm-search"] = array (
			"{resultid}" 	=> (isset($resultID_mediaresult)) ? $resultID_mediaresult : $object[$objectDefinition_mediaresult]->getID(),
			"{firstresult}" => (!$count_4_6a9d82) ? 1 : 0,
			"{lastresult}" 	=> ($count_4_6a9d82 == sizeof($results_mediaresult)-1) ? 1 : 0,
			"{resultcount}" => ($count_4_6a9d82+1),
			"{maxpages}"    => $maxPages_4_6a9d82,
			"{currentpage}" => ($search_mediaresult->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_4_6a9d82,
		);
		//IF TAG START 5_88a2e6
		...
		//IF TAG START 8_aac384
		$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('fileExtension',''))." == 'flv'", $replace);
		if ($ifcondition) {
			$func = create_function("","return (".$ifcondition.");");
			if ($func()) {
				//IF TAG START 9_334030
				$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 12_e0b9c9
			}
		}//IF TAG END 11_1b1eca
		//IF TAG START 13_b310cc
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 14_3ff34f
				//IF TAG START 15_a91ba9
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 13_b310cc
		$count_4_6a9d82++;
		//do all result vars replacement
		$content_4_6a9d82.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_4_6a9d82; //retrieve previous content var if any
	$replace = $replace_4_6a9d82; //retrieve previous replace vars if any
	$object[$objectDefinition_mediaresult] = $object_4_6a9d82; //retrieve previous object search if any
}
//RESULT mediaresult TAG END 4_6a9d82
//destroy search and results mediaresult objects
unset($search_mediaresult);
unset($results_mediaresult);
//SEARCH mediaresult TAG END 2_4bee35
echo CMS_polymod_definition_parsing::replaceVars($content, $replace);
  ?>
	</div>
	
		<div class="text"><div class="text atm-block block-674c18942a0b3dfad804467dcb834fe9 row-96b7525d5e5be588fabb9053d3bb62da" id="el-90f1aeca33d2aa84c366e8ee7df7dd96"><h3>Un syst&egrave;me d'alerte email automatique informe les validateurs des modifications qui ont &eacute;t&eacute; op&eacute;r&eacute; sur le site.&nbsp;</h3><p>Le validateur peut alors v&eacute;rifier les modifications faites sur le contenu et les accepter, les refuser ou les modifier. </p><p>Un syst&egrave;me d'ic&ocirc;nes simple et clair permet &agrave; tout moment de connaitre le statut des &eacute;l&eacute;ments : si ils sont publi&eacute;s, d&eacute;publi&eacute;s, ou attente d'une validation.</p><p>La publication en ligne des modifications n'est effective que lorsqu'elles sont approuv&eacute;es par le validateur. Ce droit particulier est param&eacute;trable dans la <a href="../../../web/fr/28-administration.php" id="ext-gen15566">gestion des utilisateurs.</a></p></div></div>
