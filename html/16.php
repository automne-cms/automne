<?php //Generated on Fri, 28 Nov 2008 15:56:52 +0100 by Automne (TM) 4.0.0a1
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	header('HTTP/1.x 301 Moved Permanently', true, 301);
	header('Location: http://localhost/web/fr/16-fonctions-annexes.php');
	exit;
}
...
<li class="CMS_lvl3 CMS_nosub CMS_current"><a class="CMS_lvl3" href="http://localhost/web/fr/16-fonctions-annexes.php">Fonctions annexes</a></li>
</ul>
</li>
