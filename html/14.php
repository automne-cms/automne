...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	...
	header('Location: http://localhost/web/fr/14-gestion-des-droits.php');
	exit;
}
...
<li class="CMS_lvl3 CMS_nosub CMS_current"><a class="CMS_lvl3" href="http://localhost/web/fr/14-gestion-des-droits.php">Gestion des droits</a></li>
