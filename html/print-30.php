...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	CMS_view::redirect('http://acezar.401/web/demo/print-30-notions-essentielles.php', true, 301);
}
...
<div align="center">
	<small>
				...
				Page  "Pré-requis" (http://acezar.401/web/demo/30-notions-essentielles.php)
				<br />
