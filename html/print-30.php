...
<<<<<<< TREE
	CMS_view::redirect('http://test-folder/trunk/web/demo/print-30-notions-essentielles.php', true, 301);
=======
...
<<<<<<< TREE
				Page  "Pré-requis" (http://test-folder/trunk/web/demo/30-notions-essentielles.php)
=======
