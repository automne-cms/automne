...
CMS_view::redirect('http://automne4.trunk/web/demo/9-contact.php', true, 302);
 ?><?php //Generated on Tue, 09 Mar 2010 11:59:12 +0100 by Automne (TM) 4.0.1
require_once($_SERVER["DOCUMENT_ROOT"]."/cms_rc_frontend.php");
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	CMS_view::redirect('http://automne4.trunk/web/demo/36-formulaire.php', true, 301);
}
