...
Modèles
	...
	<div class="imgRight">
		<?php //Generated by : $Id: print-25.php,v 1.1 2009/03/06 11:01:49 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH mediaresult TAG START 16_94add4
$objectDefinition_mediaresult = '2';
if (!isset($objectDefinitions[$objectDefinition_mediaresult])) {
	$objectDefinitions[$objectDefinition_mediaresult] = new CMS_poly_object_definition($objectDefinition_mediaresult);
}
//public search ?
$public_16_94add4 = isset($public_search) ? $public_search : false;
//get search params
$search_mediaresult = new CMS_object_search($objectDefinitions[$objectDefinition_mediaresult], $public_16_94add4);
$launchSearch_mediaresult = true;
//add search conditions if any
if ($blockAttributes['search']['mediaresult']['item']) {
	$values_17_7a6021 = array (
		'search' => 'mediaresult',
		'type' => 'item',
		'value' => 'block',
		'mandatory' => 'true',
	);
	$values_17_7a6021['value'] = $blockAttributes['search']['mediaresult']['item'];
	$launchSearch_mediaresult = (CMS_polymod_definition_parsing::addSearchCondition($search_mediaresult, $values_17_7a6021)) ? $launchSearch_mediaresult : false;
} elseif (true == true) {
	//search parameter is mandatory and no value found
	$launchSearch_mediaresult = false;
}
//RESULT mediaresult TAG START 18_e11c36
...
if ($results_mediaresult) {
	$object_18_e11c36 = $object[$objectDefinition_mediaresult]; //save previous object search if any
	$replace_18_e11c36 = $replace; //save previous replace vars if any
	$count_18_e11c36 = 0;
	$content_18_e11c36 = $content; //save previous content var if any
	$maxPages_18_e11c36 = $search_mediaresult->getMaxPages();
	$maxResults_18_e11c36 = $search_mediaresult->getNumRows();
	foreach ($results_mediaresult as $object[$objectDefinition_mediaresult]) {
		$content = "";
		$replace["atm-search"] = array (
			"{resultid}" 	=> (isset($resultID_mediaresult)) ? $resultID_mediaresult : $object[$objectDefinition_mediaresult]->getID(),
			"{firstresult}" => (!$count_18_e11c36) ? 1 : 0,
			"{lastresult}" 	=> ($count_18_e11c36 == sizeof($results_mediaresult)-1) ? 1 : 0,
			"{resultcount}" => ($count_18_e11c36+1),
			"{maxpages}"    => $maxPages_18_e11c36,
			"{currentpage}" => ($search_mediaresult->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_18_e11c36,
		);
		//IF TAG START 19_cbea07
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 20_f83961
				$content .=" ".$object[2]->getValue('label','')."</a>
				";
				//IF TAG START 21_22511e
				...
				}//IF TAG END 21_22511e
			}
		}//IF TAG END 19_cbea07
		//IF TAG START 22_ae95ec
		$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('fileExtension',''))." == 'flv'", $replace);
		if ($ifcondition) {
			$func = create_function("","return (".$ifcondition.");");
			if ($func()) {
				//IF TAG START 23_d0c215
				$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
				...
				}//IF TAG END 23_d0c215
				//IF TAG START 24_3ab39a
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 22_ae95ec
		//IF TAG START 25_d1bfb5
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 26_eb2c89
			}
		}//IF TAG END 25_d1bfb5
		//IF TAG START 27_0ca70c
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 28_c59fcf
				//IF TAG START 29_145b4d
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 27_0ca70c
		$count_18_e11c36++;
		//do all result vars replacement
		$content_18_e11c36.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_18_e11c36; //retrieve previous content var if any
	$replace = $replace_18_e11c36; //retrieve previous replace vars if any
	$object[$objectDefinition_mediaresult] = $object_18_e11c36; //retrieve previous object search if any
}
//RESULT mediaresult TAG END 18_e11c36
//destroy search and results mediaresult objects
unset($search_mediaresult);
unset($results_mediaresult);
//SEARCH mediaresult TAG END 16_94add4
