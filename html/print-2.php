...
<h3>
	...
	<?php //Generated by : $Id: print-2.php,v 1.8 2009/10/23 10:20:26 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH lastNews TAG START 7_3af652
...
//public search ?
$public_7_3af652 = isset($public_search) ? $public_search : false;
//get search params
$search_lastNews = new CMS_object_search($objectDefinitions[$objectDefinition_lastNews], $public_7_3af652);
...
//RESULT lastNews TAG START 8_15f469
...
if ($results_lastNews) {
	$object_8_15f469 = (isset($object[$objectDefinition_lastNews])) ? $object[$objectDefinition_lastNews] : ""; //save previous object search if any
	$replace_8_15f469 = $replace; //save previous replace vars if any
	$count_8_15f469 = 0;
	$content_8_15f469 = $content; //save previous content var if any
	$maxPages_8_15f469 = $search_lastNews->getMaxPages();
	$maxResults_8_15f469 = $search_lastNews->getNumRows();
	foreach ($results_lastNews as $object[$objectDefinition_lastNews]) {
		...
		$replace["atm-search"] = array (
			...
			"{firstresult}" => (!$count_8_15f469) ? 1 : 0,
			"{lastresult}" 	=> ($count_8_15f469 == sizeof($results_lastNews)-1) ? 1 : 0,
			"{resultcount}" => ($count_8_15f469+1),
			"{maxpages}"    => $maxPages_8_15f469,
			"{currentpage}" => ($search_lastNews->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_8_15f469,
		);
		$content .="
		<div class=\"lastNews\">
		<div class=\"newsTop\">
		...
		}//IF TAG END 10_c12078
		$content .="
		<div class=\"spacer\"></div>
		<div class=\"newsBottom\">
		<a class=\"newsAll\" href=\"".CMS_tree::getPageValue("5","url")."\">Toute l'actualite</a>
		";
		//FUNCTION TAG START 11_8043c5
		$parameters_11_8043c5 = array ('selected' => CMS_polymod_definition_parsing::replaceVars("3", $replace),);
		$object_11_8043c5 = &$object[1];
		if (method_exists($object_11_8043c5, "rss")) {
			$content .= CMS_polymod_definition_parsing::replaceVars($object_11_8043c5->rss($parameters_11_8043c5, array (
				0 =>
				array (
					'textnode' => '
					',
			...
			CMS_grandFather::raiseError("Malformed atm-function tag : can't found method rss on object : ".get_class($object_11_8043c5));
		}
		//FUNCTION TAG END 11_8043c5
		$content .="
		</div>
		</div>
		</div>
		...
		$content_8_15f469.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_8_15f469; //retrieve previous content var if any
	$replace = $replace_8_15f469; //retrieve previous replace vars if any
	$object[$objectDefinition_lastNews] = $object_8_15f469; //retrieve previous object search if any
}
//RESULT lastNews TAG END 8_15f469
//destroy search and results lastNews objects
unset($search_lastNews);
unset($results_lastNews);
//SEARCH lastNews TAG END 7_3af652
