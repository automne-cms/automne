...
<h3>
	...
	<?php //Generated by : $Id: print-2.php,v 1.9 2009/10/28 16:31:35 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH lastNews TAG START 7_2ddb68
...
//public search ?
$public_7_2ddb68 = isset($public_search) ? $public_search : false;
//get search params
$search_lastNews = new CMS_object_search($objectDefinitions[$objectDefinition_lastNews], $public_7_2ddb68);
...
//RESULT lastNews TAG START 8_80c377
...
if ($results_lastNews) {
	$object_8_80c377 = (isset($object[$objectDefinition_lastNews])) ? $object[$objectDefinition_lastNews] : ""; //save previous object search if any
	$replace_8_80c377 = $replace; //save previous replace vars if any
	$count_8_80c377 = 0;
	$content_8_80c377 = $content; //save previous content var if any
	$maxPages_8_80c377 = $search_lastNews->getMaxPages();
	$maxResults_8_80c377 = $search_lastNews->getNumRows();
	foreach ($results_lastNews as $object[$objectDefinition_lastNews]) {
		...
		$replace["atm-search"] = array (
			...
			"{firstresult}" => (!$count_8_80c377) ? 1 : 0,
			"{lastresult}" 	=> ($count_8_80c377 == sizeof($results_lastNews)-1) ? 1 : 0,
			"{resultcount}" => ($count_8_80c377+1),
			"{maxpages}"    => $maxPages_8_80c377,
			"{currentpage}" => ($search_lastNews->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_8_80c377,
		);
		$content .="
		<div class=\"lastNews\">
		<div class=\"newsTop\">
		...
		}//IF TAG END 10_03fdf1
		$content .="
		<div class=\"spacer\"></div>
		<div class=\"newsBottom\">
		<a class=\"newsAll\" href=\"".CMS_tree::getPageValue("5","url")."\">Toute l'actualite</a>
		";
		//FUNCTION TAG START 11_0e6d9e
		$parameters_11_0e6d9e = array ('selected' => CMS_polymod_definition_parsing::replaceVars("3", $replace),);
		$object_11_0e6d9e = &$object[1];
		if (method_exists($object_11_0e6d9e, "rss")) {
			$content .= CMS_polymod_definition_parsing::replaceVars($object_11_0e6d9e->rss($parameters_11_0e6d9e, array (
				0 =>
				array (
					'textnode' => '
					',
			...
			CMS_grandFather::raiseError("Malformed atm-function tag : can't found method rss on object : ".get_class($object_11_0e6d9e));
		}
		//FUNCTION TAG END 11_0e6d9e
		$content .="
		</div>
		</div>
		</div>
		...
		$content_8_80c377.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_8_80c377; //retrieve previous content var if any
	$replace = $replace_8_80c377; //retrieve previous replace vars if any
	$object[$objectDefinition_lastNews] = $object_8_80c377; //retrieve previous object search if any
}
//RESULT lastNews TAG END 8_80c377
//destroy search and results lastNews objects
unset($search_lastNews);
unset($results_lastNews);
//SEARCH lastNews TAG END 7_2ddb68
