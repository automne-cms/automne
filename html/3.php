...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	...
	header('Location: http://localhost/web/fr/3-presentation.php');
	exit;
}
...
<a id="lienAccueil" href="http://localhost/web/fr/2-accueil.php" title="Retour à l'accueil">Retour à l'accueil</a>
				...
				<div id="backgroundBottomContainer">
					<div id="menuLeft">
						<ul class="CMS_lvl1"><li class="CMS_lvl1 CMS_open "><a class="CMS_lvl1" href="http://localhost/web/fr/2-accueil.php">Accueil</a><ul class="CMS_lvl2"><li class="CMS_lvl2 CMS_nosub CMS_current"><a class="CMS_lvl2" href="http://localhost/web/fr/3-presentation.php">Présentation</a></li>
