...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	...
	header('Location: http://localhost/web/fr/6-mediatheque.php');
	exit;
}
...
<li class="CMS_lvl2 CMS_nosub CMS_current"><a class="CMS_lvl2" href="http://localhost/web/fr/6-mediatheque.php">Médiathèque</a></li>
</ul>
</li>
</ul>
 ...
 &gt; 
	...
	<?php //Generated by : $Id: 6.php,v 1.2 2008/11/28 14:54:13 sebastien Exp $
$content = "";
$replace = "";
if (!isset($objectDefinitions) || !is_array($objectDefinitions)) $objectDefinitions = array();
$blockAttributes = array (
...
<option value=\"\"> </option>
";
//FUNCTION TAG START 2_6e5247
$parameters_2_6e5247 = array ('selected' => CMS_polymod_definition_parsing::replaceVars(CMS_poly_definition_functions::getVarContent("request", "cat", "int", @$cat), $replace),);
$object_2_6e5247 = &$object[2]->objectValues(8);
if (method_exists($object_2_6e5247, "selectOptions")) {
	$content .= CMS_polymod_definition_parsing::replaceVars($object_2_6e5247->selectOptions($parameters_2_6e5247, NULL), $replace);
} else {
	CMS_grandFather::raiseError("Malformed atm-function tag : can't found method selectOptions on object : ".get_class($object_2_6e5247));
}
//FUNCTION TAG END 2_6e5247
$content .="
</select>
</div>
