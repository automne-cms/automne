...
<a href="http://127.0.0.1/web/fr/24-documentation.php">Fonctionnalités</a>
 ...
 &gt; 
	...
	<div class="imgRight">
		<?php //Generated by : $Id: 28.php,v 1.1 2009/03/06 11:01:49 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH mediaresult TAG START 2_9255bf
$objectDefinition_mediaresult = '2';
if (!isset($objectDefinitions[$objectDefinition_mediaresult])) {
	$objectDefinitions[$objectDefinition_mediaresult] = new CMS_poly_object_definition($objectDefinition_mediaresult);
}
//public search ?
$public_2_9255bf = isset($public_search) ? $public_search : false;
//get search params
$search_mediaresult = new CMS_object_search($objectDefinitions[$objectDefinition_mediaresult], $public_2_9255bf);
$launchSearch_mediaresult = true;
//add search conditions if any
if ($blockAttributes['search']['mediaresult']['item']) {
	$values_3_5730f9 = array (
		'search' => 'mediaresult',
		'type' => 'item',
		'value' => 'block',
		'mandatory' => 'true',
	);
	$values_3_5730f9['value'] = $blockAttributes['search']['mediaresult']['item'];
	$launchSearch_mediaresult = (CMS_polymod_definition_parsing::addSearchCondition($search_mediaresult, $values_3_5730f9)) ? $launchSearch_mediaresult : false;
} elseif (true == true) {
	//search parameter is mandatory and no value found
	$launchSearch_mediaresult = false;
}
//RESULT mediaresult TAG START 4_f00b70
...
if ($results_mediaresult) {
	$object_4_f00b70 = $object[$objectDefinition_mediaresult]; //save previous object search if any
	$replace_4_f00b70 = $replace; //save previous replace vars if any
	$count_4_f00b70 = 0;
	$content_4_f00b70 = $content; //save previous content var if any
	$maxPages_4_f00b70 = $search_mediaresult->getMaxPages();
	$maxResults_4_f00b70 = $search_mediaresult->getNumRows();
	foreach ($results_mediaresult as $object[$objectDefinition_mediaresult]) {
		$content = "";
		$replace["atm-search"] = array (
			"{resultid}" 	=> (isset($resultID_mediaresult)) ? $resultID_mediaresult : $object[$objectDefinition_mediaresult]->getID(),
			"{firstresult}" => (!$count_4_f00b70) ? 1 : 0,
			"{lastresult}" 	=> ($count_4_f00b70 == sizeof($results_mediaresult)-1) ? 1 : 0,
			"{resultcount}" => ($count_4_f00b70+1),
			"{maxpages}"    => $maxPages_4_f00b70,
			"{currentpage}" => ($search_mediaresult->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_4_f00b70,
		);
		//IF TAG START 5_6a9db2
		...
		//IF TAG START 8_f62c28
		$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('fileExtension',''))." == 'flv'", $replace);
		if ($ifcondition) {
			$func = create_function("","return (".$ifcondition.");");
			if ($func()) {
				//IF TAG START 9_e07b28
				$ifcondition = CMS_polymod_definition_parsing::replaceVars(CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 12_2428f5
			}
		}//IF TAG END 11_9617ca
		//IF TAG START 13_e4a337
		...
		if ($ifcondition) {
			...
			if ($func()) {
				...
				}//IF TAG END 14_571469
				//IF TAG START 15_982073
				$ifcondition = CMS_polymod_definition_parsing::replaceVars("!".CMS_polymod_definition_parsing::prepareVar($object[2]->objectValues(9)->getValue('thumbnail','')), $replace);
				if ($ifcondition) {
					$func = create_function("","return (".$ifcondition.");");
					if ($func()) {
		...
		}//IF TAG END 13_e4a337
		$count_4_f00b70++;
		//do all result vars replacement
		$content_4_f00b70.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_4_f00b70; //retrieve previous content var if any
	$replace = $replace_4_f00b70; //retrieve previous replace vars if any
	$object[$objectDefinition_mediaresult] = $object_4_f00b70; //retrieve previous object search if any
}
//RESULT mediaresult TAG END 4_f00b70
//destroy search and results mediaresult objects
unset($search_mediaresult);
unset($results_mediaresult);
//SEARCH mediaresult TAG END 2_9255bf
