...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	CMS_view::redirect('http://automne4.401/web/demo/print-31-exemples-de-modules.php', true, 301);
}
...
<div align="center">
	<small>
				...
				Page  "Exemples de modules" (http://automne4.401/web/demo/31-exemples-de-modules.php)
				<br />
