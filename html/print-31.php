...
<<<<<<< TREE
	CMS_view::redirect('http://test-folder/trunk/web/demo/print-31-exemples-de-modules.php', true, 301);
=======
	CMS_view::redirect('http://127.0.0.1/web/demo/print-31-exemples-de-modules.php', true, 301);
>>>>>>> MERGE-SOURCE
}
...
<<<<<<< TREE
				Page  "Exemples de modules" (http://test-folder/trunk/web/demo/31-exemples-de-modules.php)
=======
				Page  "Exemples de modules" (http://127.0.0.1/web/demo/31-exemples-de-modules.php)
>>>>>>> MERGE-SOURCE
				<br />
