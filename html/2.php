<?php //Generated on Fri, 28 Nov 2008 15:56:34 +0100 by Automne (TM) 4.0.0a1
		...
		<div id="container">
			...
			<div id="menuLeft">
				<div id="menuLeftBottom">
					<ul class="CMS_lvl2">
						<li class="CMS_lvl2"><a class="CMS_lvl2" href="http://localhost/web/fr/3-presentation.php">Présentation</a></li>
<li class="CMS_lvl2"><a class="CMS_lvl2" href="http://localhost/web/fr/4-fonctionnalites.php">Fonctionnalités</a></li>
<li class="CMS_lvl2"><a class="CMS_lvl2" href="http://localhost/web/fr/5-actualite.php">Actualités</a></li>
<li class="CMS_lvl2"><a class="CMS_lvl2" href="http://localhost/web/fr/6-mediatheque.php">Médiathèque</a></li>
...
<div class="text"><p><strong>Automne est votre solution</strong> si vous recherchez un outil de gestion de contenu performant et &eacute;volutif, permettant autonomie et contr&ocirc;le &eacute;ditorial. Que votre contenu soit statique ou dynamique avec une gestion en bases de donn&eacute;es, Automne facilite la communication et les &eacute;changes <strong>sans contraintes techniques.<br /></strong></p></div>
	...
	<?php //Generated by : $Id: 2.php,v 1.2 2008/11/28 14:54:13 sebastien Exp $
$content = "";
$replace = "";
...
//SEARCH lastNews TAG START 2_9cd49b
...
//public search ?
$public_2_9cd49b = isset($public_search) ? $public_search : false;
//get search params
$search_lastNews = new CMS_object_search($objectDefinitions[$objectDefinition_lastNews], $public_2_9cd49b);
...
//RESULT lastNews TAG START 3_288968
...
if ($results_lastNews) {
	$object_3_288968 = $object[$objectDefinition_lastNews]; //save previous object search if any
	$replace_3_288968 = $replace; //save previous replace vars if any
	$count_3_288968 = 0;
	$content_3_288968 = $content; //save previous content var if any
	$maxPages_3_288968 = $search_lastNews->getMaxPages();
	$maxResults_3_288968 = $search_lastNews->getNumRows();
	foreach ($results_lastNews as $object[$objectDefinition_lastNews]) {
		...
		$replace["atm-search"] = array (
			...
			"{firstresult}" => (!$count_3_288968) ? 1 : 0,
			"{lastresult}" 	=> ($count_3_288968 == sizeof($results_lastNews)-1) ? 1 : 0,
			"{resultcount}" => ($count_3_288968+1),
			"{maxpages}"    => $maxPages_3_288968,
			"{currentpage}" => ($search_lastNews->getAttribute('page')+1),
			"{maxresults}"  => $maxResults_3_288968,
		);
		$content .="
		<div class=\"newsTop\">
		...
		";
		//FUNCTION TAG START 5_4536a8
		$parameters_5_4536a8 = array ('selected' => CMS_polymod_definition_parsing::replaceVars("3", $replace),);
		$object_5_4536a8 = &$object[1];
		if (method_exists($object_5_4536a8, "rss")) {
			$content .= CMS_polymod_definition_parsing::replaceVars($object_5_4536a8->rss($parameters_5_4536a8, array (
				0 =>
				array (
					'textnode' => '
					',
			...
			CMS_grandFather::raiseError("Malformed atm-function tag : can't found method rss on object : ".get_class($object_5_4536a8));
		}
		//FUNCTION TAG END 5_4536a8
		$content .="
		</div>
		</div>
		";
		...
		$content_3_288968.= CMS_polymod_definition_parsing::replaceVars($content, $replace);
	}
	$content = $content_3_288968; //retrieve previous content var if any
	$replace = $replace_3_288968; //retrieve previous replace vars if any
	$object[$objectDefinition_lastNews] = $object_3_288968; //retrieve previous object search if any
}
//RESULT lastNews TAG END 3_288968
//destroy search and results lastNews objects
unset($search_lastNews);
unset($results_lastNews);
//SEARCH lastNews TAG END 2_9cd49b
