...
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	...
	header('Location: http://automne4/web/fr/13-gestion-des-utilisateurs.php');
	exit;
}
...
<li class="CMS_lvl3 CMS_nosub CMS_current"><a class="CMS_lvl3" href="http://automne4/web/fr/13-gestion-des-utilisateurs.php">Les utilisateurs</a></li>
