<?php //Generated on Fri, 28 Nov 2008 15:56:48 +0100 by Automne (TM) 4.0.0a1
if (!isset($cms_page_included) && !$_POST && !$_GET) {
	header('HTTP/1.x 301 Moved Permanently', true, 301);
	header('Location: http://localhost/web/fr/13-gestion-des-utilisateurs.php');
	exit;
}
...
<li class="CMS_lvl2 CMS_open "><a class="CMS_lvl2" href="http://localhost/web/fr/4-fonctionnalites.php">Fonctionnalités</a><ul class="CMS_lvl3"><li class="CMS_lvl3 CMS_nosub "><a class="CMS_lvl3" href="http://localhost/web/fr/11-gestion-de-contenu.php">Gestion de contenu</a></li>
<li class="CMS_lvl3 CMS_nosub "><a class="CMS_lvl3" href="http://localhost/web/fr/12-modules.php">Modules</a></li>
<li class="CMS_lvl3 CMS_nosub CMS_current"><a class="CMS_lvl3" href="http://localhost/web/fr/13-gestion-des-utilisateurs.php">Les utilisateurs</a></li>
...
<li class="CMS_lvl3 CMS_nosub "><a class="CMS_lvl3" href="http://localhost/web/fr/15-module-actualites-mediatheque.php">Les modules</a></li>
...
<li class="CMS_lvl2 CMS_nosub "><a class="CMS_lvl2" href="http://localhost/web/fr/6-mediatheque.php">Médiathèque</a></li>
					...
					<div id="content" class="page13">
						<div id="breadcrumbs">
							<a href="http://localhost/web/fr/2-accueil.php">Accueil</a>
 &gt; 
<a href="http://localhost/web/fr/4-fonctionnalites.php">Fonctionnalités</a>
 &gt; 
