...
---------------------------
 	...
 	2. Create a database (it's only a single click in PhyMyAdmin) or be sure to have access to an existing database
	...
	6. In order to keep your webserver secure we recommend you to delete both install.php and automne-xxx.tar.gz
