# $Id: automne4-I18NM_messages.sql,v 1.27 2009/11/10 17:01:24 sebastien Exp $
#
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (391, 'standard', NOW(), 'Ce champ vous permet d''activer ou de désactiver le cache du navigateur de l''internaute pour cette page.', 'This field allows you to enable or disable the browser cache for this page.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (402, 'standard', NOW(), 'Etes-vous sûr de vouloir supprimer définitivement le groupe :', 'Are you sure you want to permanently delete the group: ');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (411, 'standard', NOW(), 'Etes-vous sûr de vouloir supprimer définitivement l''utilisateur', 'Are you sure you want to permanently delete the user');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (427, 'standard', NOW(), 'Eléments en attente de validation sélectionnés. Cliquez sur "Valider par lot" pour valider ces éléments.', 'elements awaiting validation selected. Click on "Submit a lot" to validate these elements.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (428, 'standard', NOW(), 'Cette action fermera la fenêtre des validations.<br />Etes-vous sûr ?', 'This action will close the window of validations. <br /> Are you sure?');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (450, 'standard', NOW(), 'Copier la page et son contenu vers un autre point de l''arborescence.', 'Copy the page and its contents to another item on the tree.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (451, 'standard', NOW(), 'Etes-vous sûr de vouloir déverrouiller cette page ? Les modifications en cours par %s peuvent être perdues.', 'Are you sure you want to unlock this page? The changes underway by %s may be lost.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (456, 'standard', NOW(), 'Déplacer la page et son contenu vers un autre point de l''arborescence.', 'Move the page and its contents to another item on the tree.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (457, 'standard', NOW(), 'Archiver la page en dehors de l''arborescence. La page ne sera plus consultable mais pourra être replacée dans l''arborescence plus tard. Cette action est soumise à validation et peut être annulée.', 'Archive page outside of the tree. The page will no longer be available but may be placed in the tree later. This action is subject to validation and maybe cancelled.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (458, 'standard', NOW(), 'Etes-vous sûr de vouloir archiver la page ?<br /><br />Cette action est soumise à la validation.', 'Are you sure you want to archiving the page ?<br /><br />This action is subject to validation.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (459, 'standard', NOW(), 'Supprimer définitivement la page. Cette action est soumise à validation et peu être annulée.', 'Delete the final page. This action is subject to validation and maybe cancelled.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (460, 'standard', NOW(), 'Etes-vous sûr de vouloir supprimer définitivement la page ?<br /><br />Cette action est soumise à la validation.', 'Are you sure you want to finally delete the page? <br /><br />This action is subject to validation.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (461, 'standard', NOW(), 'Annuler l''édition de la page en attente de validation. Son contenu correspondra alors à l''état de la précédente validation. Cette action n''est pas soumise à validation et prend effet immédiatement.', 'Undo editing page awaiting validation. Its contents will return to the status of the previous validation. This action is not subject to validation and takes effect immediately.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (471, 'standard', NOW(), 'L''utilisateur ne peux voir que les éléments du module visibles côté client. L''accès côté administration d''Automne lui est impossible.', 'The user can only see frontend elements of the module. Backend access is not allowed.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (472, 'standard', NOW(), 'L''utilisateur accède au côté client et administration d''Automne pour ce module.', 'The user can see frontend and backend elements for this module.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (488, 'standard', NOW(), 'Ce droit permet de régénérer les pages du site manuellement et de contrôler les scripts en tâche de fond.', 'This right give control on pages regenerations and all scripts tasks in background.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (491, 'standard', NOW(), 'Ce droit permet de donner l''accès au journal de toutes les actions. Il permet aussi de le purger.', 'This right give the access to all actions logs in Automne. It allows logs deletion too.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (505, 'standard', NOW(), 'Vous ne pouvez pas modifier les droits de cette page pour cet utilisateur car ils dépendent des groupes auxquels il appartient. Modifiez les groupes de l''utilisateur pour modifier ses droits sur Automne.', 'You can not modify the rights of this page for this user because they depend on the groups to which it belongs. Change the groups the user to modify its rights in Automne.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (508, 'standard', NOW(), 'Vous ne pouvez pas modifier les droits de cette page pour cet utilisateur car ils dépendent des groupes auxquels il appartient. Modifiez les groupes de l''utilisateur pour modifier ses droits sur Automne.', 'You can not modify the rights of this page for the user because they depend on the groups to which it belongs. Change the groups the user to modify its rights in Automne.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (510, 'standard', NOW(), 'Cette case permet d''autoriser la validation des éléments du module pour lequels l''utilisateur a le droit d''administration.', 'This box allows you to authorize the validation elements of the module for which the user to the right of directors.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (564, 'standard', NOW(), 'Si vous cochez cette case, la page sera créée sans les rangées. Si vous ne la cochez pas, les rangées par défaut seront insérées dans la page.', 'If you check this box, the page will be created without any default content rows. If you do not check it, the default template rows will be added to all content zone of the created pagge.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (565, 'standard', NOW(), 'Créer la page sans les rangées par défaut', 'Create page without any default rows');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (577, 'standard', NOW(), 'Supprime le ou les modèles sélectionnés. Un modèle utilisé ne peut être supprimé.', 'Remove the or these selected templates. A template must not be used anymore to be removed.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (581, 'standard', NOW(), 'Désactive le ou les modèles sélectionnés. Un modèle inactif ne peut être utilisé pour créer des pages.', 'Desactivate the or these selected templates. An inactive template can not be used to create new pages.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (585, 'standard', NOW(), 'Supprime la ou les rangées sélectionnées. Une rangée utilisée ne peut être supprimée.', 'Remove the or these selected templates. A template must not be used anymore to be removed.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (587, 'standard', NOW(), 'Active la ou les rangées sélectionnées. Une rangée active peut être utilisé dans des pages.', 'Activate the or these selected rows. An active row can be used into pages.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (588, 'standard', NOW(), 'Désactive la ou les rangées sélectionnées. Une rangée inactive ne peut être ajoutée dans des pages.', 'Desactivate the or these selected rows. An inactive row can not be added into pages.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (589, 'standard', NOW(), 'Modification de la ou des rangées sélectionnées.', 'Modification of the or these selected rows.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (602, 'standard', NOW(), 'Titre des liens des pages dans l''arborescence', 'Page link name in tree');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (614, 'standard', NOW(), 'Activer la vérification des droits côté client', 'Activate rights checking on frontend');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (619, 'standard', NOW(), 'Cette adresse sera utilisée comme adresse d''émission des différents emails générés par le système, tant côté administration (validations en attente) que côté public (emails de formulaires).', 'This address will be used as the sender address of emails generated by the system, both side administration (validation pending) than public side (email forms).');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (620, 'standard', NOW(), 'Dans l''arborescence des pages, permet de basculer entre l''affichage des titres des pages et l''affichage des libellés des liens des pages lorsque les titres des pages sont trop longs.', '	In the pages tree, you can toggle between displaying the titles of pages and the display of titles of links of pages when the titles of pages are too long.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (626, 'standard', NOW(), 'Si le débuggage système et les statistiques de débuggage sont actifs, cette option permet l''affichage des statistiques détaillées de traitement PHP et MySQL des scripts du site. Un lien vers ces statistiques sera proposé dans la console de débuggage d''Automne ou en bas de page.', 'If the system debugging and statistics debugging is active, this option allows the display of detailed statistical treatment for PHP and MySQL scripts on the site.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (655, 'standard', NOW(), 'La page demandée (%s) ne peut-être affichée. Il est possible qu''elle ait été supprimée ou que vous n''ayez pas le droit de la consulter.<br />Veuillez sélectionner une nouvelle page dans l''arborescence ou par le moteur de recherche.', 'The requested page (%s) can not be displayed. It is possible that it has been deleted it or you do not have right to consult it.<br />Please select a new page in the tree or by the search engine.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (658, 'standard', NOW(), 'Vous pouvez ajouter cette page aux favoris d''Automne pour pouvoir y accéder plus rapidement ! Pour la retrouver ensuite, allez dans la barre latérale puis dans "Gestion des pages".', 'You can add this page to Automne bookmarks to access it faster! To find it, go in the sidebar and then on "Pages management".');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (659, 'standard', NOW(), 'Cette page est déjà marquée comme favorite. Cliquez à nouveau pour l''enlever de vos favoris.', 'This page is already in your bookmarks. Click again to remove it.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (672, 'standard', NOW(), '<h1>Version :</h1> Automne <strong>%s</strong> - Dernière mise à jour : %s <br /><br /> <h1>Modules installés :</h1> Polymod - Version : %s<br /> %s <br /> <h1>Sites de la communauté Automne :</h1> <ul class="atm-server"> <li class="atm-pic-logo"><a href="http://www.automne.ws" target="_blank">Visitez le site officel d''Automne</a> : Vous y trouverez toutes les nouveautés.</li> <li class="atm-pic-logo"><a href="http://doc.automne.ws" target="_blank">Toute la documentation Automne en ligne</a> : Pour toutes les explications sur l''utilisation d''Automne ainsi que des tutoriaux.</li> <li class="atm-pic-logo"><a href="http://www.automne.ws/forum/" target="_blank">Forum des utilisateurs d''Automne</a> : Pour communiquer avec d''autres utilisateurs et échanger vos idées ou vos problèmes.</li> </ul> <br /> <h1>Vos impressions sur Automne :</h1> Vous pouvez nous envoyer vos commentaires sur Automne sur <a href="http://www.automne.ws/contact/" target="_blank">cette page</a>.<br />Toutes vos remarques et critiques seront les bienvenues ! <br /><br /> <h1>Besoin de formation ou de support ?</h1> <a href="http://www.automne.ws/support/" target="_blank">N''hésitez pas à nous contacter</a>. Nous proposons des formations par niveau ainsi qu''une offre de support professionnel. <br /><br /> <fieldset> Automne est un logiciel sous license open source GNU-GPL créé par<br /><br /> <a href="http://www.ws-interactive.fr" target="_blank"><img src="/automne/admin/img/logo-ws.png" alt="WS Interactive" title="WS Interactive" /></a> </fieldset>', '<h1>Version:</h1>\nAutomne <strong>%s</strong> - Last update: %s\n<br /><br />\n<h1>Installed modules:</h1>\nPolymod - Version: %s<br />\n%s\n<br />\n<h1>Automne community websites:</h1>\n<ul class="atm-server">\n	<li class="atm-pic-logo"><a href="http://www.automne.ws" target="_blank">Visit offical Automne website</a>: You can find all the news.</li>\n	<li class="atm-pic-logo"><a href="http://doc.automne.ws" target="_blank">All Automne inline documentation</a> : For all the explanation on the use of Automne as well as tutorials..</li>\n	<li class="atm-pic-logo"><a href="http://www.automne.ws/forum/" target="_blank">Forum of Automne users</a> : Contacting other users and share your ideas or your problems.</li>\n</ul>\n<br />\n<h1>Your impressions of Automne:</h1>\nYou can send us your comments on <a href="http://www.automne.ws/contact/" target="_blank">this page</a>.<br />All your comments and criticisms are welcome!\n<br /><br />\n<h1>Need Training or Support?</h1>\n<a href="http://www.automne.ws/support/" target="_blank">Feel free to contact us</a>. We provide training at all levels as well as professional support services.\n<br /><br />\n<fieldset>\n	Automne is an open source software licensed under GNU-GPL and created by<br /><br />\n	<a href="http://www.ws-interactive.fr" target="_blank"><img src="/automne/admin/img/logo-ws.png" alt="WS Interactive" title="WS Interactive" /></a>\n</fieldset>');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (673, 'standard', NOW(), 'Cette page vous présente les différentes informations concernant votre version d''Automne ainsi que tous les sites d''aide disponibles pour la communauté.', 'This page presents various information about your version of Automne and all websites available to help the community.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (680, 'standard', NOW(), 'Cette page vous permet de paramétrer diverses fonctionnalités d''Automne. Référez vous à l''aide disponible sur chaque paramètre pour en connaître l''usage.', 'This page allows you to set various features of Automne. Refer to the help available on each parameter to know the usage.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (681, 'standard', NOW(), 'Vous pouvez modifier les %s. Référez-vous à l''aide disponible sur chaque paramètre pour en connaître l''utilité.<br /><br />Ces paramètres sont aussi directement accessibles dans le fichier : /automne/classes/modules/%s_rc.xml', 'You can change the %s. Refer to the help available on each parameter to know the utility.<br /> <br /> These parameters are also directly accessible in the file: /automne/classes/modules/%s_rc.xml');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (697, 'standard', NOW(), 'Vous n''avez pas le droit de dupliquer les branches d''arborescence.', 'You are not allowed to duplicate the branches of trees.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (728, 'standard', NOW(), 'Cette fenêtre regroupe les différentes aides nécessaires à la création de rangées de contenu pour chacun des modules.', 'This window lists all the various aids necessary for the creation of rows of content for each module.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (752, 'standard', NOW(), 'Permet de valider qu''Automne possède bien les droits nécessaires sur l''ensemble des fichiers du site.', 'Used to validate that Automne has required rights to all files on the site.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (753, 'standard', NOW(), 'Pour les utilisateurs :', 'For users:');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (754, 'standard', NOW(), 'Permet de valider que les utilisateurs et internautes possèdent bien les droits nécessaires sur l''ensemble des fichiers du site.', 'Used to validate users and Internet users have the rights necessary to all files on the site.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (763, 'standard', NOW(), '... Il y a plus de 1000 fichiers inaccessibles en écriture ...', '... There are more than 1000 files inaccessible for writing ...');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (771, 'standard', NOW(), 'Permet de recréer les pages des différents sites visibles côté client.', 'Lets recreate the visible client-side pages of the different websites.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (870, 'standard', NOW(), '[La page de destination doit être validée]', '[The new destination page must be validated]');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1017, 'standard', NOW(), 'Cliquer sur l''image à l''aide du bouton gauche de la souris.<br />Maintenir le bouton et déplacer la souris vers le coin gauche pour redimmensionner l''image.<br />Une fois l''image à la taille désirée, relacher le bouton. L''image sera recompressée après validation.<br /><br />ATTENTION : agrandir une image la pixelise.', 'With the mouse, click on the image and with the button still pressed, move the mouse to resize the image. Once done, validate.<br />\r\nAttention, multiple resize actions can hinder the quality of the image!');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1090, 'standard', NOW(), 'Tâches', 'Task');
...
<br /><br />Pour plus d\'informations,<br /><a href="http://www.automne.ws/faq/" target="_blank">Consultez le site d\'Automne</a>.', 'Your navigator is obsolete...<br />\nPlease use a more recent version:<br />\n<ul>\n	<li><a href="http://www.mozilla.com/firefox/" target="_blank">Mozilla - Firefox</a></li>\n	<li><a href="http://www.google.com/chrome/" target="_blank">Google - Chrome</a></li>\n	<li><a href="http://www.apple.com/safari/" target="_blank">Apple - Safari</a></li>\n	<li><a href="http://www.microsoft.com/ie/" target="_blank">Microsoft - Internet Explorer</a></li>\n</ul>
<br /><br />For more informations,<br /><a href="http://www.automne.ws/faq/" target="_blank">Visit Automne website</a>.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1111, 'standard', NOW(), 'Les feuilles de style utilisent du code CSS spécifique à votre site %s. <br /> Attention, Toute modification peut entraîner des changements visuels sur l''ensemble de votre site !', 'Style sheets use CSS code specific to your site %s.<br />Attention, Any modification can change the visual of all your site!');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1179, 'standard', NOW(), 'Etes-vous sûr de vouloir finaliser l''installation ?', 'Are you sure to want to finalize installation ?');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1182, 'standard', NOW(), '[Une fenêtre pop-up a tenté de s''ouvrir sans succès. Merci de désactiver le système anti pop-up de votre navigateur pour ce site.]', '[A pop-up window attempted to open without success.\nThank you to deactivate the anti pop-up system of your browser for this site.]');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1217, 'standard', NOW(), 'Gestion des accès par groupe d''utilisateurs', 'Users groups categories access management');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1218, 'standard', NOW(), 'Se souvenir de mon compte', 'Remember me');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1219, 'standard', NOW(), '<div class="rowComment"> <h1>Titre ou sous-titre (255 charact&egrave;res max) :</h1> <div class="retrait"><span class="code">&lt;block module=&quot;standard&quot; type=&quot;varchar&quot; id=&quot;<span class="keyword">uniqueID</span>&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span> <ul> <li> <span class="keyword">uniqueID :</span>&nbsp;Identifiant unique du bloc dans la rang&eacute;e.</li></ul>Les valeurs suivantes seront remplac&eacute;es dans le tag : <ul> <li> <span class="vertclair">{{data}} :</span>&nbsp;Contenu textuel.</li></ul> </div> <h1>Texte mis en forme (HTML) :</h1> <div class="retrait"><span class="code">&lt;block module=&quot;standard&quot; type=&quot;text&quot; id=&quot;<span class="keyword">uniqueID</span>&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span> <ul> <li> <span class="keyword">uniqueID :</span>&nbsp;Identifiant unique du bloc dans la rang&eacute;e.</li></ul>Les valeurs suivantes seront remplac&eacute;es dans le tag : <ul> <li> <span class="vertclair">{{data}} :</span>&nbsp;Contenu mis en forme (HTML).</li></ul> </div> <h1>Image :</h1> <div class="retrait"><span class="code">&lt;block module=&quot;standard&quot; type=&quot;image&quot; id=&quot;<span class="keyword">uniqueID</span>&quot; maxWidth=&quot;<span class="keyword">value</span>&quot; minWidth=&quot;<span class="keyword">value</span>&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span> <ul> <li> <span class="keyword">uniqueID :</span>&nbsp;Identifiant unique du bloc dans la rang&eacute;e.</li> <li> <span class="keyword">value :</span>&nbsp;Valeur minimum ou maximum autoris&eacute;e pour l''image en pixels. Les attributs maxWidth et minWidth sont optionnels.</li></ul>Les valeurs suivantes seront remplac&eacute;es dans le tag : <br/> <ul> <li><span class="vertclair">{{data}} :</span>&nbsp;Code de l''image et lien vers l''image zoom si elle existe.</li> <li><span class="vertclair">{{label}}</span> ou <span class="vertclair">{{linkLabel}} :</span>&nbsp;Nom / Légende de l''image le cas échéant.</li> <li><span class="vertclair">{{jslabel}} :</span>&nbsp;Nom de l''image (&eacute;chapp&eacute; pour insertion dans du javascript ou un attribut de tag).</li> <li><span class="vertclair">{{imageZoomHtml}} :</span>&nbsp;Code HTML affichant l''image zoom si elle existe.</li> <li><span class="vertclair">{{imagePath}} :</span>&nbsp;Répertoire de l''image sur le serveur.</li> <li><span class="vertclair">{{imageName}} :</span>&nbsp;Nom du fichier image sur le serveur.</li> <li><span class="vertclair">{{imageZoomHref}} :</span>&nbsp;Adresse (répertoire et nom) du fichier Image zoom sur le serveur.</li> <li><span class="vertclair">{{imageZoomName}} :</span>&nbsp;Nom du fichier image zoom sur le serveur.</li> <li><span class="vertclair">{{imageWidth}} :</span>&nbsp;Largeur du fichier image sur le serveur.</li> <li><span class="vertclair">{{imageHeight}} :</span>&nbsp;Hauteur du fichier image sur le serveur.</li> <li><span class="vertclair">{{imageZoomWidth}} :</span>&nbsp;Largeur du fichier image zoom sur le serveur.</li> <li><span class="vertclair">{{imageZoomHeight}} :</span>&nbsp;Hauteur du fichier image zoom sur le serveur.</li> </ul> </div> <h1>Fichier - Pi&egrave;ce jointe :</h1> <div class="retrait"><span class="code">&lt;block module=&quot;standard&quot; type=&quot;file&quot; id=&quot;<span class="keyword">uniqueID</span>&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span> <ul> <li> <span class="keyword">uniqueID :</span>&nbsp;Identifiant unique du bloc dans la rang&eacute;e.</li></ul> Les valeurs suivantes seront remplac&eacute;es dans le tag : <ul> <li> <span class="vertclair">{{data}} :</span>&nbsp;Lien vers le fichier si il existe.</li> <li> <span class="vertclair">{{href}} :</span>&nbsp;Adresse (URL) du fichier. </li> <li> <span class="vertclair">{{label}} :</span>&nbsp;Libell&eacute; du fichier. </li> <li> <span class="vertclair">{{jslabel}} :</span>&nbsp;Libell&eacute; du fichier (&eacute;chapp&eacute; pour insertion dans du javascript ou un attribut de tag). </li> <li> <span class="vertclair">{{size}} :</span>&nbsp;Taille du fichier en m&eacute;ga octets. </li> <li> <span class="vertclair">{{filename}} :</span>&nbsp;Nom du fichier. </li> <li> <span class="vertclair">{{originalfilename}} :</span>&nbsp;Nom original du fichier. </li> <li> <span class="vertclair">{{type}} :</span>&nbsp;Extension du fichier. </li> <li> <span class="vertclair">{{icon}} :</span>&nbsp;Icône de ce type de fichier si elle existe. </li> </ul> </div> <h1>Animation Flash :</h1> <div class="retrait"><span class="code">&lt;block module=&quot;standard&quot; type=&quot;flash&quot; id=&quot;<span class="keyword">uniqueID</span>&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span> <ul> <li> <span class="keyword">uniqueID :</span>&nbsp;Identifiant unique du bloc dans la rang&eacute;e.</li></ul>Les valeurs suivantes seront remplac&eacute;es dans le tag : <br/> <ul> <li> <span class="vertclair">{{data}} :</span>&nbsp;Contenu de l''animation flash.</li></ul> </div> </div>', '<ol><li>Title or sub-title<br />&lt;block module="standard" type="varchar" id="uniqueID"&gt;{{data}}&lt;/block&gt;</li><li>Free text<br />&lt;block module="standard" type="text" id="uniqueID"&gt;{{data}}&lt;/block&gt;</li><li>Image<br />&lt;block module="standard" type="image" id="uniqueID"&gt;{{data}} and / or {{linkLabel}}&lt;/block&gt;<br />NB : Attributes maxWidth and minWidth enable you to control the width of the image for each block image.</li><li>File<br />&lt;block module="standard" type="file" id="uniqueID"&gt;{{data}}&lt;/block&gt;</li><li>Flash Animation<br />&lt;block module="standard" type="flash" id="uniqueID"&gt;{{data}}&lt;/block&gt;</li></ol><b>uniqueID :</b> Unique identifier of the block for the row.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1222, 'standard', NOW(), '<div class="rowComment"> <h1>Titre de la page courante :</h1> <div class="retrait"><span class="code">&lt;atm-title /&gt;</span></div> <h1>M&eacute;ta-donn&eacute;es de la page courante :</h1> <div class="retrait"><span class="code">&lt;atm-meta-tags /&gt;</span> <br /><strong>Ce tag est obligatoire dans tous les modèles.</strong> </div> <h1>Valeur d''une constante (voir les fichiers de constantes d''Automne) :</h1> <div class="retrait"><span class="code">&lt;atm-constant name=&quot;<span class="keyword">constantName</span>&quot; /&gt;</span> <ul> <li> <span class="keyword">constantName :</span>&nbsp;Nom de la constante &agrave; afficher. </li> </ul> </div> <h1>Lien(s) vers une ou plusieur pages :</h1> <div class="retrait"><span class="code">&lt;atm-linx type=&quot;<span class="keyword">linxType</span>&quot;&gt;<span class="vertclair">linxDefinition</span>&lt;/atm-linx&gt;</span> <ul> <li> <span class="keyword"> linxType : </span> &nbsp;Type de lien parmi : <ul> <li> <span class="keyword"> direct : </span> &nbsp;Lien direct vers une page donn&eacute;e. </li> <li> <span class="keyword"> sublinks : </span> &nbsp;Liens vers les sous pages de la page courante. </li> <li> <span class="keyword"> desclinks : </span> &nbsp;Historique de navigation d''une page &agrave; une autre. </li> <li> <span class="keyword"> recursivelinks : </span> &nbsp;Arborescence de sous liens depuis une page donn&eacute;e. </li> </ul> </li> <li> <span class="vertclair"> linxDefinition : </span> &nbsp;<a href="http://www.automne.ws/docs/" target="_blank">Voir la documentation Automne pour le d&eacute;tail</a>. </li> </ul> </div> <h1>Zone de contenu : Permet l''affichage de rang&eacute;es de contenu :</h1> <div class="retrait"><span class="code">&lt;atm-clientspace module=&quot;standard&quot; id=&quot;<span class="keyword">uniqueID</span>&quot; /&gt;</span> <ul> <li> <span class="keyword"> uniqueID : </span> &nbsp;Identifiant unique de la zone de contenu dans le mod&egrave;le. </li> </ul> </div> <h1>Lien vers la page d''impression :</h1> <div class="retrait"><span class="code">&lt;atm-print-link keeprequest=&quot;<span class="keyword">true</span>&quot;&gt;<span class="vertclair">{{href}}</span>&lt;/atm-print-link&gt;</span> <ul> <li> <span class="vertclair"> {{href}} : </span> &nbsp;Remplac&eacute; par le lien vers la page imprimable. </li> <li> <span class="keyword"> Attribut keeprequest : </span> &nbsp;Optionnel, permet de conserver les attributs GET avec lesquels la page à imprimer est appelée (defaut : false) </li> </ul> </div> <h1>Date de dernière mise à jour :</h1> <div class="retrait"><span class="code">&lt;atm-last-update format=&quot;<span class="keyword">d-m-Y</span>&quot;&gt;<span class="vertclair">{{date}} {{firstname}} {{lastname}}</span>&lt;/atm-last-update&gt;</span> <ul> <li> <span class="vertclair"> {{date}} : </span> &nbsp;Date de la dernière mise à jour du contenu de la page. Le format de la date à afficher est donné par l''attribut <span class="keyword">format</span> du tag. </li> <li> <span class="vertclair"> {{firstname}} : </span> &nbsp;Prénom de la personne responsable de la dernière mise à jour. </li> <li> <span class="vertclair"> {{lastname}} : </span> &nbsp;Nom de la personne responsable de la dernière mise à jour. </li> </ul> </div> <h1>Fichiers Javascripts de la page :</h1> <div class="retrait"><span class="code">&lt;atm-js-tags files=&quot;<span class="keyword">/js/js1.js,/js/js2.js</span>&quot; /&gt;</span> <ul> <li> <span class="keyword"> Attribut files : </span> &nbsp;Fichiers javascript à inclure dans la page (séparés par des virgules). <br/> Les fichiers ainsi listés seront concaténés et compressés avant d''être servis à l''internaute. Une gestion avancée du cache sur le navigateur de l''internaute est employée. </li> </ul> </div> <h1>Feuilles de styles CSS de la page :</h1> <div class="retrait"><span class="code">&lt;atm-css-tags files=&quot;<span class="keyword">/css/css1.css,/css/css2.css</span>&quot; /&gt;</span> <ul> <li> <span class="keyword"> Attribut files : </span> &nbsp;Feuilles de styles CSS à inclure dans la page (séparés par des virgules). <br/> Les fichiers ainsi listés seront concaténés et compressés avant d''être servis à l''internaute. Une gestion avancée du cache sur le navigateur de l''internaute est employée. Seul le média <span class="keyword">screen</span> est concerné pour ces fichiers. </li> </ul> </div> <h1>Identifiant de la page :</h1> <div class="retrait"><span class="code"><span class="keyword">{{pageID}}</span></span> <ul> <li> <span class="keyword"> {{pageID}} : </span> &nbsp;Remplacé par l''identifiant de la page en cours. </li> </ul> </div> </div>', '<ol>\r\n<li>\r\n	Title of the current page:<br />\r\n	&lt;atm-title /&gt;\r\n</li>\r\n<li>\r\n	Metadata of the current page:<br />\r\n	&lt;atm-meta-tags /&gt;\r\n</li>\r\n<li>\r\n	Value of a constant (see Automne constants files):<br />\r\n	&lt;atm-constant name="constantName" /&gt;<br />\r\n	<b>constantName :</b> Name of the constant to display.\r\n</li>\r\n<li>\r\n	link(s) to one or several pages:<br />\r\n	&lt;atm-linx type="linxType"&gt;linxDefinition&lt;/atm-linx&gt;<br />\r\n	<b>linxType :</b> link type between:\r\n	<ul>\r\n		<li>''direct'' : Direct link to a given page.</li>\r\n		<li>''sublinks'' : Links to subpages of the current page.</li>\r\n		<li>''desclinks'' : Navigation history from a page to another.</li>\r\n		<li>''recursivelinks'' : Tree structure of sublinks from a given page.</li>\r\n	</ul>\r\n	<b>linxDefinition :</b> See Automne documentation for the detail.\r\n</li>\r\n<li>\r\n	Content zone : Alow use of content rows :<br />\r\n	&lt;atm-clientspace module="standard" id="uniqueID" /&gt;<br />\r\n	<b>uniqueID :</b> Unique identifier of the content zone for the template.\r\n</li>\r\n<li>\r\n	Link to the printable page :<br />\r\n	&lt;atm-print-link&gt;{{href}}&lt;/atm-print-link&gt;<br />\r\n	<b>{{href}} :</b> will be replaced by the link to the printable page.\r\n</li>\r\n</ol>');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1240, 'standard', NOW(), 'Visible côté client', 'Available in frontend');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1293, 'standard', NOW(), '[Erreur : vous n''avez pas les droits suffisants sur le module ''%s'' pour lui ajouter une rangée.]', '[Error: you do not have sufficient rights on the module ''%s'' to add a row to it.]');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1309, 'standard', NOW(), 'Le module est créé mais certaines erreurs se sont produites lors de la création des répertoires du module. Vérifiez que les répertoires suivants existent et sont accessibles en écriture : %s, %s, %s, %s', 'Module is created but some errors append for module directories creation.\nPlease check following directories exists and are writable :\n%s,\n%s,\n%s,\n%s');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1310, 'standard', NOW(), 'L''utilisateur %s fait parti du groupe %s. Modifier directement ses droits enlèvera l''utilisateur de ce groupe. Etes-vous sûr de vouloir continuer ?', '%s user makes party of the group %s. Modify its rights directly will remove the user of this group. Do you want to continue?');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1311, 'standard', NOW(), 'Vous n''avez pas de droits d''utilisation sur aucun modèle de pages.', 'You do not have any rights of use on any pages templates.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1312, 'standard', NOW(), 'Vous ne pouvez créer de nouvelle page : Vous n''avez pas de droits d''utilisation sur aucun modèle de pages.', 'You cannot create of new page: You do not have any rights of use on any pages templates.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1337, 'standard', NOW(), '[Modification interdite des groupes de rangées]', '[Modification of unauthorized rows groups]');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1353, 'standard', NOW(), '[Erreur lors du réordonnancement des sites ...]', '[Error during websites reorder...]');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1455, 'standard', NOW(), 'Sélectionnés', 'Selected');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1462, 'standard', NOW(), 'Utilisez une vignette représentant le visuel du modèle de page pour permettre une sélection plus aisée.', 'Use a thumbnail representing the visual page template to allow for easier selection.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1469, 'standard', NOW(), 'Cette fenêtre regroupe les différentes aides nécessaires à la création de modèles pour chaque module.', 'This window lists all the various aids necessary to construct models for each module.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1505, 'standard', NOW(), 'Impossible de créer le fichier %s, son extension est incorrecte.', 'Unable to create file %s, its extension is incorrect.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1524, 'standard', NOW(), 'Vous n''avez pas le droit de dupliquer les branches d''arborescence.', 'You are not allowed to duplicate the branches of trees.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1548, 'standard', NOW(), 'Enregistrer et régénérer', 'Save and regenerate');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1549, 'standard', NOW(), 'Enregistrer la définition XML et régénérer toutes les pages qui emploient cette rangée pour une application directe des modifications sur le ou les sites.', 'Save the XML definition and regenerate all the pages that use this row for a direct application of the changes on the site.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1550, 'standard', NOW(), 'Enregistrer la définition XML et régénérer toutes les pages qui emploient ce modèle pour une application directe des modifications sur le ou les sites.', 'Save the XML definition and regenerate all the pages that use this template for a direct application of the changes on the site.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1551, 'standard', NOW(), 'Erreur durant l\'écriture de la rangée. Vérifiez les droits sur les fichiers du serveur.', 'Error while writing the row. Check the files rights on the server.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1552, 'standard', NOW(), 'Erreur durant l\'écriture du modèle. Vérifiez les droits sur les fichiers du serveur.', 'Error while writing the template. Check the files rights on the server.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1553, 'standard', NOW(), 'Attribut :attr incorrect pour le tag :el', 'Incorrect attribute :attr for the tag :el');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1554, 'standard', NOW(), 'Attribut :attr non autorisé pour le tag :el', 'Attribute :attr non autorised for the tag :el');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1555, 'standard', NOW(), 'Attribut :attr manquant pour le tag :el', 'Attribut :attr missing for the tag :el');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1556, 'standard', NOW(), 'Le tag :el ne peut directement contenir de texte', 'Tag :el can not directly contain text');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1557, 'standard', NOW(), 'Tag :el non autorisé', 'Tag :el non autorised');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1558, 'standard', NOW(), 'Position du tag :el1 incorrecte par rapport au tag :el2', 'Position of tag :el1 incorrect in relation to tag :el2');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1559, 'standard', NOW(), 'La fermeture du tag :el a été trouvé alors qu\'elle n\'était pas attendue', 'The closing tag :el was found when it was not expected');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1560, 'standard', NOW(), 'La fermeture du tag :el1 a été trouvé alors que celle du tag :el2 était attendue', 'The closing tag :el1 was found while the closing tag :el2 was expected');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1561, 'standard', NOW(), 'Le tag :el n\'est pas fermé', 'Tag :el is not closed');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1562, 'standard', NOW(), 'Le tag :el n\'est pas fermé', 'Tag :el is not closed');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1563, 'standard', NOW(), 'Le tag :el ne peut être vide et ne doit pas posséder de "/" dans le tag ouvrant', 'Tag :el can not be empty and must not have a "/" in the opening tag');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1564, 'standard', NOW(), 'Montrer / cacher le code', 'Show / hide code');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1565, 'standard', NOW(), 'Caractère ', 'Character ');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1566, 'standard', NOW(), 'Valider le contenu XHTML du Wysiwyg', 'Validate the XHTML content of Wysiwyg');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1567, 'standard', NOW(), 'En activant cette option, le code XHTML saisi dans le Wysiwyg sera validé en détail. Les tags et leurs attributs seront analysés pour déterminer la conformité du code saisi. Si cette option est désactivée, seule la conformitée XML du code sera vérifiée.', 'By activating this option, the XHTML code entered in the Wysiwyg will be validated in detail. Tags and their attributes will be analyzed to determine compliance of the code entered. If this option is disabled, only the XML compliance of the code will be verified.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1568, 'standard', NOW(), 'Nouvelle édition du contenu', 'New content edition');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1569, 'standard', NOW(), 'Cette fenêtre vous permet de consulter le journal des actions effectuées par les utilisateurs sur les pages, les modules et les autres éléments administrable d\'Automne.', 'This window allows you to view the log of actions performed by users on the pages, modules and other administrative elements of Automne.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1570, 'standard', NOW(), 'Par Page, Module, Utilisateur', 'For Pages, Modules, Users');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1571, 'standard', NOW(), 'Identification', 'Identification');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1572, 'standard', NOW(), 'Identification automatique (cookie)', 'Automatic identification (cookies)');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1573, 'standard', NOW(), 'Gestion', 'Manage');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1574, 'standard', NOW(), 'Emails', 'Emails');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1575, 'standard', NOW(), 'Identifications', 'Identifications');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1576, 'standard', NOW(), 'Toutes les actions', 'All actions');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1577, 'standard', NOW(), 'Actions administratives', 'Administrative actions');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1578, 'standard', NOW(), 'Actions de publication', 'Publication actions');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1579, 'standard', NOW(), 'Elément', 'Element');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1580, 'standard', NOW(), 'Actions {0} à {1} sur {2}', 'Actions {0} to {1} on {2}');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1581, 'standard', NOW(), 'Aucune action pour votre recherche ...', 'No action for your search ...');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1582, 'standard', NOW(), 'Par module', 'By module');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1583, 'standard', NOW(), 'Par utilisateur', 'By user');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1584, 'standard', NOW(), 'Par type', 'By type');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1590, 'standard', NOW(), 'Vous êtes sur le point de supprimer tout le contenu de la page !<br /><br />Etes-vous sur de vouloir tout supprimer ?', 'You are about to delete the entire contents of the page!<br /><br />Are you sure you want to delete everything?');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1591, 'standard', NOW(), 'le %s à %s', 'on %s at %s');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1592, 'standard', NOW(), 'Validation directe', 'Direct validation');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1593, 'standard', NOW(), 'Attention, les alertes sur les pages sont désactivées dans votre profil utilisateur. Il vous faut les réactiver pour recevoir les emails d\'alertes spécifiés ci-dessous.', 'Warning, alerts on pages are disabled in your user profile. You must reactivate them to receive email alerts specified below.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1594, 'standard', NOW(), 'Cet onglet est désactivé car cet utilisateur est le Super administrateur et il ne peut appartenir à un groupe.', 'This tab is disabled because this user is the Super administrator and he can not belong to a group.');
...
#
# Contenu de la table `I18NM_messages` pour le module cms_aliases
#
...
#
# Contenu de la table `I18NM_messages` pour le module cms_forms
#
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (6, 'cms_forms', NOW(), 'Aucun résultat trouvé', 'No results found');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (35, 'cms_forms', NOW(), 'Vous devez sélectionner au minimum une catégorie', 'Choose at least one category');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (49, 'cms_forms', NOW(), 'Saisissez le nombre maximum de réponses désirées par utilisateur, ou laissez vide pour ne pas limiter ce nombre', 'Enter the maximum number of wished answers per users, or to leave vacuum not to limit this number ');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (56, 'cms_forms', NOW(), 'Saisissez le message d''entête pour les emails', 'Enter the header message for emails');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (91, 'cms_forms', NOW(), 'Le formulaire a expiré suite à une longue inactivité. Veuillez le soumettre à nouveau.', 'The form has expired after a long inactivity. Please submit it again.');

DELETE FROM I18NM_messages WHERE module='pmedia';

#
# Contenu de la table `I18NM_messages` pour le module pmedia
#

INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (1, 'pmedia', NOW(), 'Médiathèque', 'Mediacenter');


DELETE FROM I18NM_messages WHERE module='pnews';

#
# Contenu de la table `I18NM_messages` pour le module pnews
#
...
#
# Contenu de la table `I18NM_messages` pour le module polymod
#
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (114, 'polymod', NOW(), '<div class="rowComment"> <h1>Tags de travail :</h1> <div class="retrait"> <h3>Afficher le contenu du tag si la condition est remplie :</h3> <div class="retrait"> <span class="code"> &lt;atm-if what=&quot;<span class="keyword">condition</span>&quot;&gt; ... &lt;/atm-if&gt; </span> <ul> <li><span class="keyword">condition</span> : Condition &agrave; remplir pour afficher le contenu du tag. L''usage courant est de valider la pr&eacute;sence d''une valeur non nulle. Cette condition peut aussi prendre toutes les formes valides d''une condition PHP (voir : <a target="_blank" href="http://www.php.net/if" class="admin">Les structures de contr&ocirc;le en PHP</a>). La condition sera remplie si la valeur existe ou bien n''est pas nulle ou bien n''est pas &eacute;gale &agrave; faux (false).</li> </ul> </div> <h3>Boucler sur un ensemble d''objets :</h3> <div class="retrait"> <span class="code">&lt;atm-loop on=&quot;<span class="keyword">objets</span>&quot;&gt; ... &lt;/atm-loop&gt;</span> <ul> <li><span class="keyword">objets</span> : Collection d''objets. Employ&eacute; pour traiter tous les objets d''un ensemble d''objets multiple (dit multi-objet).</li> </ul> Les valeurs suivantes seront remplac&eacute;es dans le tag : <ul> <li><span class="vertclair">{firstloop}</span> : Vrai si l''objet en cours est le premier de la liste d''objets.</li> <li><span class="vertclair">{lastloop}</span> : Vrai si l''objet en cours est le dernier de la liste d''objets.</li> <li><span class="vertclair">{loopcount}</span> : Num&eacute;ro de l''objet en cours dans la liste d''objets.</li> <li><span class="vertclair">{lastloop}</span> : Vrai si l''objet en cours est le dernier de la liste d''objets.</li> <li><span class="vertclair">{maxloops}</span> : Nombre d''objets sur lesquels boucler.</li> </ul> </div> <h3>Ajouter un attribut au tag XHTML p&egrave;re (contenant ce tag) :</h3> <div class="retrait"> <span class="code"> &lt;atm-parameter attribute=&quot;<span class="keyword">attributeName</span>&quot; value=&quot;<span class="keyword">attributeValue</span>&quot; /&gt; </span> <ul> <li><span class="keyword">attributeName</span> : Nom de l''attribut &agrave; ajouter.</li> <li><span class="keyword">attributeValue</span> : Valeur de l''attribut &agrave; ajouter.</li> </ul> </div> <h3>Assigner une valeur &agrave; une variable :</h3> <div class="retrait"> <span class="code">&lt;atm-setvar vartype=&quot;<span class="keyword">type</span>&quot; varname=&quot;<span class="keyword">name</span>&quot; value=&quot;<span class="keyword">varValue</span>&quot; /&gt; </span> <ul> <li><span class="keyword">type </span>: Type de la variable &agrave; assigner : <span class="vertclair">request</span>, <span class="vertclair">session</span> ou <span class="vertclair">var</span>.</li> <li><span class="keyword">name </span>: Nom de la variable &agrave; assigner. Attention, r&eacute;assigner une variable existante supprimera l''ancienne valeur.</li> <li><span class="keyword">varValue</span> : valeur &agrave; assigner &agrave; la variable.</li> </ul> </div> </div> </div>', 'TODO');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (127, 'polymod', NOW(), '[Erreur : la recherche ayant l''identifiant ''%s'' dans la rangée ''%s'' n''est pas valide : Un des paramètres porte sur un champ inexistant.]', '[Error : search with ''%s'' ID in ''%s'' row is not valid : One of its parameter relates to a non-existent field.]');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (128, 'polymod', NOW(), 'Nombre de résultats par page', 'Number of results per pages');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (132, 'polymod', NOW(), 'Par création d''objet', 'By object creation');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (133, 'polymod', NOW(), '[Erreur : la recherche ayant l''identifiant ''%s'' dans la rangée ''%s'' n''est pas valide : Le type de l''un de ces paramètres est inconnu : ''%s'']', '[Error : search with ''%s'' ID in ''%s'' row is not valid : The type of the one of its parameters is unknown : ''%s'']');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (136, 'polymod', NOW(), '[Erreur : la recherche ayant l''identifiant ''%s'' dans la rangée ''%s'' n''est pas valide : Le type de l''un de ces paramètres de tri est inconnu : ''%s'']', '[Error : search with ''%s'' ID in ''%s'' row is not valid : The type of the one of its sort parameters is unknown : ''%s'']');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (139, 'polymod', NOW(), '<div class="rowComment"> <h1>Variables g&eacute;n&eacute;rales :</h1> <div class="retrait"> <h3>Variables relatives aux pages :</h3> <div class="retrait"> Les variables relatives aux pages sont de la forme <span class="vertclair">{page:<span class="keyword">id</span>:<span class="keyword">type</span>}</span>: <ul> <li><span class="keyword">id </span>: Identifiant de la page &agrave; laquelle faire r&eacute;f&eacute;rence, peut &ecirc;tre un identifiant num&eacute;rique d''une page ou bien ''<span class="vertclair">self</span>'' pour faire r&eacute;f&eacute;rence &agrave; la page courante.</li> <li><span class="keyword">type</span> : type de donn&eacute;e souhait&eacute; pour la page parmi les suivants : <span class="vertclair">url </span>(adresse de la page), <span class="vertclair">printurl </span>(adresse de la page d''impression), <span class="vertclair">id </span>(identifiant de la page), <span class="vertclair">title </span>(nom de la page).</li> </ul> </div> <h3>Variables relatives aux donn&eacute;es envoy&eacute;es (via une adresse ou un formulaire) :</h3> <div class="retrait"> Ces variables correspondent &agrave; une variable provenant de la soumission d''un formulaire ou bien d''un param&egrave;tre du lien ayant amen&eacute; &agrave; la page en cours. <br /> Elles sont de la forme <span class="vertclair">{request:<span class="keyword">type</span>:<span class="keyword">name</span>}</span> : <ul> <li><span class="keyword">type</span> : Correspond au type de variable attendu, parmi les suivants : <br /> <ul> <li><span class="vertclair">int </span>: nombre entier,&nbsp;</li> <li><span class="vertclair">string </span>: cha&icirc;ne de caract&egrave;re,&nbsp;</li> <li><span class="vertclair">safestring </span>: cha&icirc;ne de caract&egrave;re sans code HTML,&nbsp;</li> <li><span class="vertclair">bool </span>: bool&eacute;en,&nbsp;</li> <li><span class="vertclair">array</span>: tableau de valeurs,&nbsp;</li> <li><span class="vertclair">email </span>: email valide,</li> <li><span class="vertclair">date </span>: date valide sans heure (retourne une date au format MySQL : YYYY-MM-DD),</li> <li><span class="vertclair">datetime </span>: date valide avec heure (retourne une date au format MySQL : YYYY-MM-DD HH:MM:SS).</li> <li><span class="vertclair">localisedDate</span> : date valide sans heure (retourne une date au format de votre langue actuelle : %s).</li> </ul> </li> <li><span class="keyword">name</span> : Correspond au nom de la variable souhait&eacute; (nom du param&egrave;tre dans l''url ou bien nom du champ du formulaire).</li> </ul> </div> <h3>Variables de session :</h3> <div class="retrait"> Ces variables sont disponibles tout au long de la navigation du visiteur sur le site. <br /> Elles sont de la forme <span class="vertclair">{session:<span class="keyword">type</span>:<span class="keyword">name</span>}</span> : <ul> <li><span class="keyword">type</span> : Correspond au type de variable attendu, parmi les suivants : <ul> <li><span class="vertclair">int </span>: nombre entier,&nbsp;</li> <li><span class="vertclair">string </span>: cha&icirc;ne de caract&egrave;re,&nbsp;</li> <li><span class="vertclair">bool </span>: bool&eacute;en,&nbsp;</li> <li><span class="vertclair">array</span>: tableau de valeurs,&nbsp;</li> <li><span class="vertclair">email </span>: email valide,</li> <li><span class="vertclair">date </span>: date valide sans heure (retourne une date au format MySQL : YYYY-MM-DD),</li> <li><span class="vertclair">datetime </span>: date valide avec heure (retourne une date au format MySQL : YYYY-MM-DD HH:MM:SS).</li> <li><span class="vertclair">localisedDate</span> : date valide sans heure (retourne une date au format de votre langue actuelle : %s).</li> </ul> </li> <li><span class="keyword">name</span> : Correspond au nom de la variable souhait&eacute; (nom de la variable de session).</li> </ul> </div> <h3>Variables&nbsp;:</h3> <div class="retrait"> Ces variables correspondent &agrave; des variables PHP classiques. <br /> Elles sont de la forme <span class="vertclair">{var:<span class="keyword">type</span>:<span class="keyword">name</span>}</span> : <ul> <li><span class="keyword">type</span> : Correspond au type de variable attendu, parmi les suivants : <ul> <li><span class="vertclair">int </span>: nombre entier,&nbsp;</li> <li><span class="vertclair">string </span>: cha&icirc;ne de caract&egrave;re,&nbsp;</li> <li><span class="vertclair">bool </span>: bool&eacute;en,&nbsp;</li> <li><span class="vertclair">array</span>: tableau de valeurs,&nbsp;</li> <li><span class="vertclair">email </span>: email valide</li> <li><span class="vertclair">date </span>: date valide sans heure (retourne une date au format MySQL : YYYY-MM-DD),</li> <li><span class="vertclair">datetime </span>: date valide avec heure (retourne une date au format MySQL : YYYY-MM-DD HH:MM:SS).</li> <li><span class="vertclair">localisedDate</span> : date valide sans heure (retourne une date au format de votre langue actuelle : %s).</li> </ul> </li> <li><span class="keyword">name</span> : Correspond au nom de la variable souhait&eacute; (nom de la variable PHP).</li> </ul> </div> </div> </div>', 'TODO');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (155, 'polymod', NOW(), 'Code HTML complet du lien. Le titre du lien peut-être modifié grâce à un paramètre (facultatif)', 'Complete HTML code of the link. Link title can be changed with a parameter (optional)');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (211, 'polymod', NOW(), 'Conserver l''image originale de la vignette comme image zoom', 'Keep the original image of the thumbnail as an image zoom');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (219, 'polymod', NOW(), 'Chemin du répertoire de l''image et de l''image zoom', 'Path to the image and image zoom');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (246, 'polymod', NOW(), 'Chemin du répertoire du fichier et de la vignette', 'Path to the file and thumbnail');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (248, 'polymod', NOW(), 'Hauteur de la vignette en pixels', 'Thumbnail height in pixels');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (249, 'polymod', NOW(), 'Autoriser l''utilisation de fichiers du répertoire FTP', 'Allow usage of FTP files');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (250, 'polymod', NOW(), '(Permet d''utiliser un répertoire d''Automne pour déposer des gros fichiers via FTP)', '(Allow, for big files, to use an Automne directory to store files with FTP)');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (259, 'polymod', NOW(), 'Nombre d''utilisateurs/groupes associés à ce champ', 'Number of users/groups associated to this field');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (269, 'polymod', NOW(), 'Ce paramètre exclut les autres', 'This parameter exclude the others');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (288, 'polymod', NOW(), '<div class="rowComment"> <h1>Bloc de donn&eacute;es d''un module WYSIWYG :</h1> <span class="code"> &lt;atm-plugin language=&quot;<span class="keyword">languageCode</span>&quot;&gt;<br /> &nbsp;&nbsp;&nbsp; <span class="keyword">&lt;atm-plugin-valid&gt;</span><br /> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; ...<br /> &nbsp;&nbsp;&nbsp; <span class="keyword">&lt;/atm-plugin-valid&gt;</span><br /> &nbsp;&nbsp;&nbsp; <span class="keyword">&lt;atm-plugin-invalid&gt;</span><br /> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; ...<br /> &nbsp;&nbsp;&nbsp; <span class="keyword">&lt;/atm-plugin-invalid&gt;</span><br /> &lt;/atm-plugin&gt;</span><br /> <br /> Ce tag permet l''affichage de donn&eacute;es sp&eacute;cifiques &agrave; un objet dans l''&eacute;diteur de texte visuel (WYSIWYG).<br /> Le <span class="keyword">tag atm-plugin-valid</span> sera lu si l''objet s&eacute;lectionn&eacute; est valide (non supprim&eacute;, valid&eacute; et en cours de publication).<br /> Le tag <span class="keyword">atm-plugin-invalid </span>(facultatif) sera lu si l''objet s&eacute;lectionn&eacute; est invalide (supprim&eacute;, non valid&eacute; ou dont les dates de publication sont d&eacute;pass&eacute;es ou si l''utilisateur n''a pas les droits de consultation de cet objet).<br /> <ul> <li><span class="keyword">languageCode </span>: Code du langage relatif au contenu parmi les codes suivants : <span class="vertclair">%s</span>.</li> <li><span class="keyword">{plugin:selection}</span> : Sera replac&eacute; par la valeur textuelle s&eacute;lectionn&eacute;e dans l''&eacute;diteur (facultatif).</li> </ul> </div>', 'TODO');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (321, 'polymod', NOW(), 'Si ce paramètre est à :<br/>"oui" : seuls les utilisateurs/groupes sélectionnés sont affichés dans la liste déroulante du champ.<br/>"non" : les utilisateurs sélectionnés sont exclus de la liste déroulante du champ.', 'If this parameter is :<br/>"yes" : only selected users/groups are display in the selection box of the field.<br/>"no" : selected users are excluded of the selection box of the field.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (327, 'polymod', NOW(), 'Si cet objet appartient en tant que champ à un objet indexé, inutile de l''indexer lui même', 'If this object belongs as a field to an indexed object, it is useless to index itself');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (331, 'polymod', NOW(), 'Cette option est utile pour le versioning d''objets quand les versions antérieures ne doivent pas être indexées dans le moteur de recherche.', 'This option is usefull in case of object versioning which older versions does not need to be indexed');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (337, 'polymod', NOW(), 'Ce champ permet d''envoyer une notification par email lors de la validation d''un objet', 'This field allow email notification when object is validated');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (349, 'polymod', NOW(), 'Evénement système', 'System event');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (350, 'polymod', NOW(), 'Emission', 'Sending');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (351, 'polymod', NOW(), 'L''email sera envoyé à la validation de l''objet ou déclenché par un événement système à spécifier (code PHP spécifique).', 'Email will be sent at validation or by a specified system event (specific PHP code).');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (359, 'polymod', NOW(), 'Préparation des notifications par email', 'Prepare emails notifications');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (385, 'polymod', NOW(), 'Permet de spécifier un état (oui - non)', 'Choose a state (yes - no)');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (388, 'polymod', NOW(), 'Si ce paramètre est à :<br/>"oui" : seuls les utilisateurs/groupes sélectionnés ci-dessous recevront les notifications.<br/>"non" : les utilisateurs/groupes sélectionnés ci-dessous sont exclus de la réception des notifications.', 'If this parameter is :<br/>"yes" : only selected users/groups below will receive notifications.<br/>"no" : selected users/groups below are excluded of the notifications.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (394, 'polymod', NOW(), 'Comparaison numérique de deux champs numériques flottants.', 'Numeric comparison between two float fields.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (398, 'polymod', NOW(), 'Ensemble des IDs des objets de type ''%s'' associé à ce champ.', 'All IDs of objects of type ''%s'' associated to this field.');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (516, 'polymod', NOW(), 'Modifier l''élément associé sélectionné', 'Modify selected associated element');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (532, 'polymod', NOW(), 'Titre de la page', 'Page title');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (533, 'polymod', NOW(), 'Adresse (url) de la page', 'Page Address (url)');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (534, 'polymod', NOW(), 'Identifiant de la page', 'Page Id');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (535, 'polymod', NOW(), 'Les champs suivants sont obligatoire :', 'The following fields are mandotory:');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (536, 'polymod', NOW(), 'Taille max : %s car.', 'Max length: %s char.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (537, 'polymod', NOW(), 'Le contenu du champ \'%s\' est mal formatté et il ne peut être enregistré.<br />Evitez tout copier-coller de texte depuis un éditeur de texte externe. Employez les outils ''Coller comme texte'' ou ''Coller de Word'' de la barre d''outils dans ce cas.<br /><br />Vérifiez le code source de votre contenu : il doit être composé de XHTML valide.', 'The content of the field \'%s\' is poorly formatted and can not be saved.<br />Avoid copying and pasting text from an external text editor. Use the tools ''Paste as plain text'' or ''Paste from Word'' on the toolbar in this case.<br /><br />Check the source code of your content: It must consist of valid XHTML.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (538, 'polymod', NOW(), '<strong>Liste de toutes les valeurs du champ :</strong><br />
<br />
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (539, 'polymod', NOW(), 'Comparaison numérique de deux champs.', 'Numeric comparison between two fields.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (540, 'polymod', NOW(), 'Description de la catégorie', 'Category description');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (541, 'polymod', NOW(), 'Enregistrer et Valider', 'Save and Validate');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (542, 'polymod', NOW(), 'Enregistre vos modifications et les valide automatiquement. Vos modifications seront directement publiées sur le site sans étape intermédiaire de validation.', 'Saves your changes and validate automatically. Your changes will be published directly on the site without any intermediate step of validation.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (543, 'polymod', NOW(), 'Enregistre vos modifications sans les valider. Vos modifications devront être validées avant d\'être visibles sur le site.', 'Saves your changes without validation. Your changes will be validated before being visible on the site.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (544, 'polymod', NOW(), 'Enregistre vos modifications. Vos modifications seront directement visibles sur le site.', 'Saves your changes. Your changes will be visible directly on the site.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (545, 'polymod', NOW(), 'Chemin vers la vignette si elle existe.', 'Path to the thumbnail, if exists.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (546, 'polymod', NOW(), 'Chemin vers la vignette si elle existe (utilisable dans un tag atm-loop).', 'Path to the thumbnail, if exists (usable in an atm-loop tag).');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (547, 'polymod', NOW(), 'Code HTML complet de la vignette si elle existe.', 'Complete thumbnail HTML code, if exists.');
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (548, 'polymod', NOW(), 'Code HTML complet de la vignette si elle existe (utilisable dans un tag atm-loop).', 'Complete thumbnail HTML code, if exists (usable in an atm-loop tag).');
