...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES (355, 'standard', NOW(), 'Sélectionnez la page à utiliser comme père de la page copiée :', 'Select the page to use as father of the copied page:');
...
INSERT INTO I18NM_messages (id, module, timestamp, fr, en) VALUES ('1319', 'standard', NOW(), '[La page de destination sélectionnée est déjà la page père actuelle de la page à déplacer ...]', '[The destination page selected is already the father page of the page to move...]');
