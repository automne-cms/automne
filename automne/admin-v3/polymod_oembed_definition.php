...
$content = '';
$dialog->setTitle($cms_language->getMessage(MESSAGE_PAGE_TITLE_APPLICATIONS)." :: Cr&eacute;ation / modification d'une d&eacute;finition oembed",'picto_modules.gif');
...
$dialog->setJavascript('<link rel="stylesheet" type="text/css" href="//netdna.bootstrapcdn.com/bootstrap/3.0.2/css/bootstrap.min.css" />');


$dialog->setJavascript('<script type="text/javascript" src="../codemirror/codemirror.js"></script>');
$dialog->setJavascript('<script type="text/javascript" src="../codemirror/xml.js"></script>');
$dialog->setJavascript('<script type="text/javascript" src="../codemirror/javascript.js"></script>');

$dialog->setJavascript('<script type="text/javascript" src="../codemirror/clike.js"></script>');
$dialog->setJavascript('<script type="text/javascript" src="../codemirror/htmlmixed.js"></script>');
$dialog->setJavascript('<script type="text/javascript" src="../codemirror/php.js"></script>');

$dialog->setJavascript('<link rel="stylesheet" type="text/css" href="../codemirror/codemirror.css" />');
$dialog->setJavascript('<script type="text/javascript" src="./js/oembed.js"></script>');

$content = '
<div class="container">
<form name="frm" id="oembeddef" action="'.$_SERVER["SCRIPT_NAME"].'" method="post" class="form-horizontal">
		...
		<div class="col-md-6">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    ...
			    <p class="help-block">Les pages possédant ce codename auront le spécifique à l\'oembed rajouté dans le  de la page</p>
			  </div>
			</div>
		</div>
		<div class="col-md-6">
