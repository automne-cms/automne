...
switch ($step) {
	...
	case 2:
		...
		$content .= '
						...
						<td align="center" width="130"><input type="text" name="label_'.$field->getID().'" value="'.htmlspecialchars(html_entity_decode($field->getAttribute("label"))).'" /><input type="hidden" name="name_'.$field->getID().'" value="'.$field->getAttribute("name").'" /></td>
