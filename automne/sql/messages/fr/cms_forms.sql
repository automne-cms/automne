...
INSERT INTO `messages` (`id_mes`, `module_mes`, `language_mes`, `message_mes`) VALUES(96, 'cms_forms', 'fr', 'Nom du fichier XML à utiliser en tant que template. Ce fichier doit se trouver dans /automne/templates/mail/');