...
INSERT INTO `messages` (`id_mes`, `module_mes`, `language_mes`, `message_mes`) VALUES(85, 'cms_forms', 'en', '<div class="rowComment">\n<h1>Choose a form for a page :</h1>\n<div class="retrait"><span class="code">&lt;block module=&quot;cms_forms&quot; id=&quot;form&quot;&gt;<span class="vertclair">{{data}}</span>&lt;/block&gt;</span>\n<ul><li><span class="vertclair">{{data}} : </span>Will be replaced by the form to display.</li></ul>\n</div>\n</div>');
INSERT INTO `messages` (`id_mes`, `module_mes`, `language_mes`, `message_mes`) VALUES(86, 'cms_forms', 'en', '<div class="rowComment">\n<h1>Formto display for all pages using the template:</h1>\n<div class="retrait"><span class="code">&lt;atm-clientspace module=&quot;cms_forms&quot; id=&quot;form&quot; type=&quot;formular&quot; formID=&quot;<span class="keyword">formID</span>&quot;/&gt;</span>\n<ul><li><span class="keyword">formID : </span>ID of the form to display.</li></ul>\n</div>\n</div>');
...
INSERT INTO `messages` (`id_mes`, `module_mes`, `language_mes`, `message_mes`) VALUES(94, 'cms_forms', 'en', 'Execute specific PHP code');
INSERT INTO `messages` (`id_mes`, `module_mes`, `language_mes`, `message_mes`) VALUES(95, 'cms_forms', 'en', 'File name of the PHP file to execute. This file must be in the folder /automne/templates/');
