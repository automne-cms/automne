...
--
-- Structure de la table `mod_object_oembed_definition`
--

DROP TABLE IF EXISTS `mod_object_oembed_definition`;
CREATE TABLE `mod_object_oembed_definition` (
