...
class CMS_profile extends CMS_grandFather
{
	...
	{
		return array(CLEARANCE_ADMINISTRATION_EDITVALIDATEALL 	=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_EDITVALIDATEALL,'description' => MESSAGE_CLEARANCE_ADMINISTRATION_EDITVALIDATEALL_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_REGENERATEPAGES 	=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_REGENERATEPAGES,'description' => MESSAGE_CLEARANCE_ADMINISTRATION_REGENERATEPAGES_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_TEMPLATES 		=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_TEMPLATES, 	 'description' => MESSAGE_CLEARANCE_ADMINISTRATION_TEMPLATES_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_EDIT_TEMPLATES 	=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_EDIT_TEMPLATES, 'description' => MESSAGE_CLEARANCE_ADMINISTRATION_EDIT_TEMPLATES_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_VIEWLOG 			=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_VIEWLOG, 		 'description' => MESSAGE_CLEARANCE_ADMINISTRATION_VIEWLOG_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_EDITUSERS 		=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_EDITUSERS, 	 'description' => MESSAGE_CLEARANCE_ADMINISTRATION_EDITUSERS_DESCRIPTION),
					 CLEARANCE_ADMINISTRATION_DUPLICATE_BRANCH	=> array('label' => MESSAGE_CLEARANCE_ADMINISTRATION_DUPLICATE_BRANCH,'description' => MESSAGE_CLEARANCE_ADMINISTRATION_DUPLICATE_BRANCH_DESCRIPTION),
		);
	}
	...
	function getAllModuleClearances() {
		return array(CLEARANCE_MODULE_NONE => array('label' => MESSAGE_CLEARANCE_MODULE_NONE,	'description' => MESSAGE_CLEARANCE_MODULE_NONE_DESCRIPTION),
					 CLEARANCE_MODULE_VIEW => array('label' => MESSAGE_CLEARANCE_MODULE_VIEW, 	'description' => MESSAGE_CLEARANCE_MODULE_VIEW_DESCRIPTION),
					 CLEARANCE_MODULE_EDIT => array('label' => MESSAGE_CLEARANCE_MODULE_EDIT, 	'description' => MESSAGE_CLEARANCE_MODULE_EDIT_DESCRIPTION),
		);
	}
	...
	{
		return array(MESSAGE_CLEARANCE_MODULE_CATEGORIES_NONE 	=> CLEARANCE_MODULE_NONE,
		             MESSAGE_CLEARANCE_MODULE_CATEGORIES_VIEW 	=> CLEARANCE_MODULE_VIEW,
					 MESSAGE_CLEARANCE_MODULE_CATEGORIES_EDIT 	=> CLEARANCE_MODULE_EDIT,
					 MESSAGE_CLEARANCE_MODULE_CATEGORIES_MANAGE => CLEARANCE_MODULE_MANAGE);
	}
	...
	{
		return array(MESSAGE_CLEARANCE_PAGE_NONE => CLEARANCE_PAGE_NONE,
					 MESSAGE_CLEARANCE_PAGE_VIEW => CLEARANCE_PAGE_VIEW, 
					 MESSAGE_CLEARANCE_PAGE_EDIT => CLEARANCE_PAGE_EDIT);
	}
