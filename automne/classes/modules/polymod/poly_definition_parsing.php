...
// +----------------------------------------------------------------------+
//
// $Id: poly_definition_parsing.php,v 1.1.1.1 2008/11/26 17:12:06 sebastien Exp $
...
class CMS_polymod_definition_parsing extends CMS_grandFather
{
	...
	function getContent($type = self::OUTPUT_RESULT, &$parameters) {
		...
		switch ($type) {
			case self::OUTPUT_PHP:
				...
				$return = 
				'<?php'."\n".
				'//Generated by : $Id: poly_definition_parsing.php,v 1.1.1.1 2008/11/26 17:12:06 sebastien Exp $'."\n".
				$return."\n".
				$this->_definition."\n".
	...
	protected function _searchOrderTag(&$tag) {
		...
		return '$search_'.$tag['attributes']['search'].'->addOrderCondition("'.$type.'", "'.$tag['attributes']['direction'].'");'."\n";
	}
