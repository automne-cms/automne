...
// +----------------------------------------------------------------------+
//
// $Id: poly_definition_parsing.php,v 1.8 2009/06/22 14:08:41 sebastien Exp $
	...
	function getContent($type = self::OUTPUT_RESULT, &$parameters) {
		...
		switch ($type) {
			case self::OUTPUT_PHP:
				...
				$return = 
				'<?php'."\n".
				'//Generated by : $Id: poly_definition_parsing.php,v 1.8 2009/06/22 14:08:41 sebastien Exp $'."\n".
				$return."\n".
				$this->_definition."\n".
