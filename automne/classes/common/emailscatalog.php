...
class CMS_emailsCatalog extends CMS_grandFather
{
	...
	/**
	  ...
	  * @access public
	  */
	public function setUserMessages($users, $messages, $subjects, $alertLevel = ALERT_LEVEL_VALIDATION, $module = MOD_STANDARD_CODENAME) {
	...
	/**
	  ...
	  * @access public
	  */
	public function CMS_setMessages($addresses, $message, $subject, $withApplicationLabel = true) {
