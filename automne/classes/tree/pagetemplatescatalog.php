...
class CMS_pageTemplatesCatalog extends CMS_grandFather
{
	...
	/**
	  ...
	  * @access public
	  */
	public static function getAll($includeInactive = false, $keyword = '', $groups = array(), $website = '', $tplIds = array(), $user = false, $start = 0, $limit = 0, $returnObjects = true, &$score = array()) {
		$where = 'private_pt=0';
		$select = 'id_pt';
		//keywords
		if ($keyword) {
	...
	/**
	  ...
	  * @access public
	  */
	public static function getAllGroups($returnStack = false)
	{
	...
	/**
	  ...
	  */
	public static function getCloneFromID($templateID = 0, $label = false, $setPrivate = false, $dontCopyClientSpaces = false, $tplFrom = false)
	{
		$ret = false ;
	...
	/**
	  ...
	  * @access public
	  */
	public static function getTemplateIDForCloneID($cloneID) {
		$sql = "
			select
				definitionFile_pt
			from
	...
	/**
	  ...
	  * @access public
	  */
	public static function getPagesByTemplate($template, $returnObjects = false) {
		$return = array();
		$error = false;
	...
	/**
	  ...
	  * @access public
	  */
	public static function getTemplatesReplacement($tplFrom, $user, $pageId = false) {
